...
$Output .= "<td align='right'><b>" . $this->CI->database->code2text("AMOUNT")      . "</b></td>";
$Output .= "</tr>";
...
foreach ( $Items as $Item )
{
  ...
  if ( isset($Item["about"])  ) 
  {
    if ( !isset($Item["feetype"]) || ( isset($Item["feetype"]) && $Item["feetype"] != $Item["about"] ) )
    {
      if ( isset($Item["feetype"]) )  $Output .= "<br />";
      $Output .= $Item["about"];
    }
  }
...
if ( isset($_SESSION["info"]["1"]["isil"]) && isset($_SESSION[$_SESSION["info"]["1"]["isil"]]["fees"]["amount"]) )
{
  ...
  if ( $this->countLBS() == 2 ) $Output .= "<td></td>";
	$Output .= "<td align='right'><b>" . $this->CI->database->code2text("FEETOTAL") . "</b></td>";
	$Output .= "<td width='80px' align='right'><b>";
