...
"Lumia","iPad","iPod","iPhone","Kindle",{label:"Kindle Fire",pattern:"(?:Cloud9|Silk-Accelerated)"},"Nexus","Nook","PlayBook","PlayStation Vita","PlayStation","TouchPad","Transformer",{label:"Wii U",pattern:"WiiU"},"Wii","Xbox One",{label:"Xbox 360",pattern:"Xbox"},"Xoom"]),n=function(a){return x(a,function(a,b,d){return a||(b[k]||b[/^[a-z]+(?: +[a-z]+\b)*/i.exec(k)]||RegExp("\\b"+w(d)+"(?:\\b|\\w*\\d)","i").exec(c))&&d})}({Apple:{iPad:1,iPhone:1,iPod:1},Archos:{},Amazon:{Kindle:1,"Kindle Fire":1},
Asus:{Transformer:1},"Barnes & Noble":{Nook:1},BlackBerry:{PlayBook:1},Google:{"Google TV":1,Nexus:1},HP:{TouchPad:1},HTC:{},LG:{},Microsoft:{Xbox:1,"Xbox One":1},Motorola:{Xoom:1},Nintendo:{"Wii U":1,Wii:1},Nokia:{Lumia:1},Samsung:{"Galaxy S":1,"Galaxy S2":1,"Galaxy S3":1,"Galaxy S4":1},Sony:{PlayStation:1,"PlayStation Vita":1}}),d=function(a){return x(a,function(a,b){var d=b.pattern||w(b);if(!a&&(a=RegExp("\\b"+d+"(?:/[\\d.]+|[ \\w.]*)","i").exec(c))){b=b.label||b;var e={"10.0":"10","6.4":"10 Technical Preview",
"6.3":"8.1","6.2":"8","6.1":"Server 2008 R2 / 7","6.0":"Server 2008 / Vista","5.2":"Server 2003 / XP 64-bit","5.1":"XP","5.01":"2000 SP1","5.0":"2000","4.0":"NT","4.90":"ME"};d&&b&&/^Win/i.test(a)&&!/^Windows Phone /i.test(a)&&(e=e[/[\d.]+$/.exec(a)])&&(a="Windows "+e);a=String(a);d&&b&&(a=a.replace(RegExp(d,"i"),b));a=C(a.replace(/ ce$/i," CE").replace(/\bhpw/i,"web").replace(/\bMacintosh\b/,"Mac OS").replace(/_PowerPC\b/i," OS").replace(/\b(OS X) [^ \d]+/i,"$1").replace(/\bMac (OS X)\b/,"$1").replace(/\/(\d)/,
...
g.unshift("desktop mode"),e||(e=(/\brv:([\d.]+)/.exec(c)||0)[1])):"IE"!=b&&"Trident"==h&&(a=/\brv:([\d.]+)/.exec(c))&&(b&&g.push("identifying as "+b+(e?" "+e:"")),b="IE",e=a[1]);if(r){if(P(f,"global"))if(y&&(a=y.lang.System,H=a.getProperty("os.arch"),d=d||a.getProperty("os.name")+" "+a.getProperty("os.version")),u){try{e=f.require("ringo/engine").version.join("."),b="RingoJS"}catch(Q){(a=f.system)&&a.global.system==f.system&&(b="Narwhal",d||(d=a[0].os||null))}b||(b="Rhino")}else"object"==typeof f.process&&
!f.process.browser&&(a=f.process)&&("object"==typeof a.versions&&("string"==typeof a.versions.electron?(g.push("Node "+a.versions.node),b="Electron",e=a.versions.electron):"string"==typeof a.versions.nw&&(g.push("Chromium "+e,"Node "+a.versions.node),b="NW.js",e=a.versions.nw)),b||(b="Node.js",H=a.arch,d=a.platform,e=(e=/[\d.]+/.exec(a.version))?e[0]:null));else v(a=f.runtime)==z?(b="Adobe AIR",d=a.flash.system.Capabilities.os):v(a=f.phantom)==A?(b="PhantomJS",e=(a=a.version||null)&&a.major+"."+a.minor+
"."+a.patch):"number"==typeof L.documentMode&&(a=/\bTrident\/(\d+)/i.exec(c))?(e=[e,L.documentMode],(a=+a[1]+4)!=e[1]&&(g.push("IE "+e[1]+" mode"),h&&(h[1]=""),e[1]=a),e="IE"==b?String(e[1].toFixed(1)):e[0]):"number"==typeof L.documentMode&&/^(?:Chrome|Firefox)\b/.test(b)&&(g.push("masking as "+b+" "+e),b="IE",e="11.0",h=["Trident"],d="Windows");d=d&&C(d)}e&&(a=/(?:[ab]|dp|pre|[ab]\d+pre)(?:\d+\+?)?$/i.exec(e)||/(?:alpha|beta)(?: ?\d)?/i.exec(c+";"+(r&&l.appMinorVersion))||/\bMinefield\b/i.test(c)&&
...
g.unshift("platform preview")}catch(Q){g.unshift("embedded")}else(/\bBlackBerry\b/.test(k)||/\bBB10\b/.test(c))&&(a=(RegExp(k.replace(/ +/g," *")+"/([.\\d]+)","i").exec(c)||0)[1]||e)?(a=[a,/BB10/.test(c)],d=(a[1]?(k=null,n="BlackBerry"):"Device Software")+" "+a[0],e=null):this!=B&&"Wii"!=k&&(r&&q||/Opera/.test(b)&&/\b(?:MSIE|Firefox)\b/i.test(c)||"Firefox"==b&&/\bOS X (?:\d+\.){2,}/.test(d)||"IE"==b&&(d&&!/^Win/.test(d)&&5.5<e||/\bWindows XP\b/.test(d)&&8<e||8==e&&!/\bTrident\b/.test(c)))&&!F.test(a=
D.call(B,c.replace(F,"")+";"))&&a.name&&(a="ing as "+a.name+((a=a.version)?" "+a:""),F.test(b)?(/\bIE\b/.test(a)&&"Mac OS"==d&&(d=null),a="identify"+a):(a="mask"+a,b=G?C(G.replace(/([a-z])([A-Z])/g,"$1 $2")):"Opera",/\bIE\b/.test(a)&&(d=null),r||(e=null)),h=["Presto"],g.push(a));else b+=" Mobile";if(a=(/\bAppleWebKit\/([\d.]+\+?)/i.exec(c)||0)[1]){a=[parseFloat(a.replace(/\.(\d)$/,".0$1")),a];if("Safari"==b&&"+"==a[1].slice(-1))b="WebKit Nightly",I="alpha",e=a[1].slice(0,-1);else if(e==a[1]||e==(a[2]=
(/\bSafari\/([\d.]+\+?)/i.exec(c)||0)[1]))e=null;a[1]=(/\bChrome\/([\d.]+)/i.exec(c)||0)[1];537.36==a[0]&&537.36==a[2]&&28<=parseFloat(a[1])&&"WebKit"==h&&(h=["Blink"]);r&&(t||a[1])?(h&&(h[1]="like Chrome"),a=a[1]||(a=a[0],530>a?1:532>a?2:532.05>a?3:533>a?4:534.03>a?5:534.07>a?6:534.1>a?7:534.13>a?8:534.16>a?9:534.24>a?10:534.3>a?11:535.01>a?12:535.02>a?"13+":535.07>a?15:535.11>a?16:535.19>a?17:536.05>a?18:536.1>a?19:537.01>a?20:537.11>a?"21+":537.13>a?23:537.18>a?24:537.24>a?25:537.36>a?26:"Blink"!=
...
d);g.length&&(f.description=g.join(" "));return f}var t={"function":!0,object:!0},E=t[typeof window]&&window||this,u=t[typeof exports]&&exports;t=t[typeof module]&&module&&!module.nodeType&&module;var l=u&&t&&"object"==typeof global&&global;!l||l.global!==l&&l.window!==l&&l.self!==l||(E=l);var K=Math.pow(2,53)-1,F=/\bOpera/;l=Object.prototype;var O=l.hasOwnProperty,M=l.toString,z=D();"function"==typeof define&&"object"==typeof define.amd&&define.amd?(E.platform=z,define(function(){return z})):u&&
t?B(z,function(c,l){u[l]=c}):E.platform=z}).call(this);
