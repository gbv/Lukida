...
$.opened_fullview=function(a,b){$.when($.ajax({url:"/ajax/exportlink/",method:"POST",data:{ppnlist:JSON.stringify(a),format:"zotero"},dataType:"JSON"})).then(function(a){$.each(a,function(a,b){$(".Z3988").attr("title",b)})});$.when($.ajax({url:"/ajax/linkresolver/",method:"POST",data:{ppn:a},dataType:"JSON"})).then(function(a){var c="";$.each(a,function(a,b){c+="<a href='"+b+"' target='_"+a+"'><button class='col-xs-12 col-sm-6 col-md-4 btn btn-default btn-exemplar'>Volltext ("+configlang[a.toUpperCase()]+
")</button></a>"});""!=c&&(0<$("#linkresolvercontainer_"+b).parent().length?$("#linkresolvercontainer_"+b).html("<div>"+configlang.ACCESS+"</div><div class='container-fluid'><div class='row'>"+c+"</div></div>"):$("#linkresolver_"+b).html(c))});$.when($.ajax({url:"/ajax/searchsimularpubs/",method:"POST",data:{ppn:a},dataType:"JSON"})).then(function(a){0<a.hitspack?$("#simularpubscontent_"+b).html(a.results):$("#simularpubscontent_"+b).html("<div class='col-xs-12'><div class='well'>"+configlang.NOSIMULARHITS+
"</div></div>")})};$.correctCover=function(a,b){a.onerror="";$(a).replaceWith("<span class='gbvicon'>"+b+"</span>")};
...
$.open_fullview=function(a,b,d,c){void 0===b&&(b=results.ppnlist);void 0===c&&(c=a);void 0===d&&(d="main");"main"!=d&&(b=jQuery.map(b,function(a,b){return a.toString()}));var e=dialogs.length,f=a in favors?configlang.CHECKLISTREMOVE:configlang.CHECKLIST,g=a in favors?"fa fa-star-o":"fa fa-star",h="publications"==d?$("#related_"+c).html():$("#"+c+" div.panel-heading").html(),k=new BootstrapDialog({message:$('<div id="fullbody_'+e+'"></div>').load("/ajax/fullview/"+a+"/"+e),title:h,size:BootstrapDialog.SIZE_WIDE,
closable:!0,buttons:[{id:"prevbtn",icon:"glyphicon glyphicon-chevron-left",cssClass:"btn-default fullview-button-left",action:function(c){0<b.indexOf(a)?(a=b[b.indexOf(a)-1],$("#fullbody_"+e).slideUp("fast","swing",function(){$("#fullbody_"+e).load("/ajax/fullview/"+a+"/"+e,function(){"publications"==d?c.getModalHeader().find(".bootstrap-dialog-title").html($("#related_"+a).html()):c.getModalHeader().find(".bootstrap-dialog-title").html($("#"+a+" div.panel-heading").html());$("#fullbody_"+e).slideDown("fast");
var b=c.getModalFooter().find(".checklist");a in favors?(b.find(".text").text(configlang.CHECKLISTREMOVE),b.find(".fa").removeClass("fa-star"),b.find(".fa").addClass("fa-star-o")):(b.find(".text").text(configlang.CHECKLIST),b.find(".fa").removeClass("fa-star-o"),b.find(".fa").addClass("fa-star"));$.opened_fullview(a,e)})})):$.user_message(configlang.FIRSTOBJECT,"warning")}},{id:"nextbtn",icon:"glyphicon glyphicon-chevron-right",cssClass:"btn-default fullview-button-left",action:function(c){"main"==
d&&b.indexOf(a)<results.hits-1&&b.indexOf(a)==results.hitscurr-1?$.search_next_pack(function(){b=results.ppnlist;a=b[b.indexOf(a)+1];$("#fullbody_"+e).slideUp("fast","swing",function(){$("#fullbody_"+e).load("/ajax/fullview/"+a+"/"+e,function(){"publications"==d?c.getModalHeader().find(".bootstrap-dialog-title").html($("#related_"+a).html()):c.getModalHeader().find(".bootstrap-dialog-title").html($("#"+a+" div.panel-heading").html());$("#fullbody_"+e).slideDown("fast");var b=c.getModalFooter().find(".checklist");
a in favors?(b.find(".text").text(configlang.CHECKLISTREMOVE),b.find(".fa").removeClass("fa-star"),b.find(".fa").addClass("fa-star-o")):(b.find(".text").text(configlang.CHECKLIST),b.find(".fa").removeClass("fa-star-o"),b.find(".fa").addClass("fa-star"));$.opened_fullview(a,e)})})}):b.indexOf(a)<b.length-1?(a=b[b.indexOf(a)+1],$("#fullbody_"+e).slideUp("fast","swing",function(){$("#fullbody_"+e).load("/ajax/fullview/"+a+"/"+e,function(){"publications"==d?c.getModalHeader().find(".bootstrap-dialog-title").html($("#related_"+
a).html()):c.getModalHeader().find(".bootstrap-dialog-title").html($("#"+a+" div.panel-heading").html());$("#fullbody_"+e).slideDown("fast");var b=c.getModalFooter().find(".checklist");a in favors?(b.find(".text").text(configlang.CHECKLISTREMOVE),b.find(".fa").removeClass("fa-star"),b.find(".fa").addClass("fa-star-o")):(b.find(".text").text(configlang.CHECKLIST),b.find(".fa").removeClass("fa-star-o"),b.find(".fa").addClass("fa-star"));$.opened_fullview(a,e)})})):$.user_message(configlang.LASTOBJECT,
"warning")}},{icon:"glyphicon glyphicon-menu-up",label:" "+configlang.CANCEL,action:function(a){a.close();$.focus_first()}},{id:"print",icon:"fa fa-print",label:" "+configlang.PRINT,action:function(a){a=window.open();a.document.write("<html><head><title>"+configlang.PRINT+"</title></head><body>");a.document.write($("#mail_"+e).wrap("<p/>").parent().html());a.document.write("</body></html");a.document.close();a.focus();a.print();a.close()}},{id:"mail",icon:"glyphicon glyphicon-envelope",label:" "+
configlang.MAIL,action:function(b){favormails[a]=$("#mail_"+e).wrap("<p/>").parent().html();""==usrconfig?$.login("LOGINFIRST",function(){""!=usrconfig&&$.open_mail([a])}):$.open_mail([a])}},{id:"export",icon:"glyphicon glyphicon-export",label:" "+configlang.EXPORT,action:function(b){$.open_export([a])}},{id:"checklist",icon:g,cssClass:"btn-default checklist",label:' <span class="text">'+f+"</span>",action:function(b){b=$(this);a in favors?(delete favors[a],delete favormails[a],delete favorprint[a],
$.user_message(configlang.CHECKLISTREMOVESUCCESS,"success"),b.find(".text").text(configlang.CHECKLIST),b.find(".fa").removeClass("fa-star-o"),b.find(".fa").addClass("fa-star")):(favors[a]=$("#"+a).clone().removeClass("medium col-xs-12 col-sm-6 col-md-4 col-lg-3","col-md-6").addClass("merk col-md-6"),$(favors[a]).find("a").attr("href","javascript:$.open_fullview('"+a+"',Object.keys(favors));"),favormails[a]=$("#mail_"+e).wrap("<p/>").parent().html(),favorprint[a]=$("#mail_"+e).wrap("<p/>").parent().html(),
$.user_message(configlang.CHECKLISTSUCCESS,"success"),b.find(".text").text(configlang.CHECKLISTREMOVE),b.find(".fa").removeClass("fa-star"),b.find(".fa").addClass("fa-star-o"));$.update_favors()}}],onhidden:function(){dialogs.pop();statevals.ppnlist.pop();$.push_state()},onshown:function(){dialogs.push(k);$.is_Empty(statevals)&&(statevals={});$.is_Empty(statevals.ppnlist)&&(statevals.ppnlist=[]);statevals.ppnlist.push({ppn:a,ppnlist:b,typ:d,parentppn:c});$.push_state();$.opened_fullview(a,e)}});k.realize();
k.getModalHeader().addClass("preview-header");config.button_checklist||k.getButton("checklist").hide();config.button_export||k.getButton("export").hide();config.button_mail||k.getButton("mail").hide();config.button_print||k.getButton("print").hide();k.setData("ppn",a);k.setData("name","fullview_"+e);k.open()};
$.open_assistant=function(){var a=dialogs.length,b=new BootstrapDialog({message:$('<div id="assistant_'+a+'"></div>').load("/ajax/assistant/"+a),title:configlang.ASSISTANT,size:BootstrapDialog.SIZE_WIDE,closable:!0,buttons:[{icon:"glyphicon glyphicon-menu-up",label:" "+configlang.CANCEL,action:function(a){a.close();$.focus_first()}},{icon:"fa fa-eraser",label:" "+configlang.CLEAR,action:function(b){$("#title_"+a+" textarea").val("");$("#author_"+a+" textarea").val("");$("#subject_"+a+" textarea").val("");
$("#class_"+a+" textarea").val("");$("#toc_"+a+" textarea").val("");$("#year_"+a+" textarea").val("");$("#publisher_"+a+" textarea").val("");$("#isn_"+a+" textarea").val("");$("#series_"+a+" textarea").val("");$("#id_"+a+" textarea").val("");$.focus_first()}},{icon:"glyphicon glyphicon-search",label:" "+configlang.STARTSEARCH,cssClass:"fullview-button-color",action:function(b){var c=b="",c=$.cleanArray($("#title_"+a+" textarea").val().split("\n"));0<c.length&&(b+=" title("+c.join(",")+")");c=$.cleanArray($("#author_"+
a+" textarea").val().split("\n"));0<c.length&&(b+=" author("+c.join(",")+")");c=$.cleanArray($("#subject_"+a+" textarea").val().split("\n"));0<c.length&&(b+=" subject("+c.join(",")+")");c=$.cleanArray($("#class_"+a+" textarea").val().split("\n"));0<c.length&&(b+=" class("+c.join(",")+")");c=$.cleanArray($("#toc_"+a+" textarea").val().split("\n"));0<c.length&&(b+=" toc("+c.join(",")+")");c=$.cleanArray($("#year_"+a+" textarea").val().split("\n"));0<c.length&&(b+=" year("+c.join(",")+")");c=$.cleanArray($("#publisher_"+
a+" textarea").val().split("\n"));0<c.length&&(b+=" publisher("+c.join(",")+")");c=$.cleanArray($("#isn_"+a+" textarea").val().split("\n"));0<c.length&&(b+=" isn("+c.join(",")+")");c=$.cleanArray($("#series_"+a+" textarea").val().split("\n"));0<c.length&&(b+=" series("+c.join(",")+")");c=$.cleanArray($("#id_"+a+" textarea").val().split("\n"));0<c.length&&(b+=" id("+c.join(",")+")");$.when($.new_search("init",b)).then(function(){0==results.hits?$("#assistantcount").html("<h4>"+configlang.ASSISTANTNO+
"</h4>"):$("#assistantcount").html("<h4>"+$.format_hits(results.hits)+" "+configlang.ASSISTANTYES+"</h4>")})}}],onhidden:function(){dialogs.pop()},onshown:function(){dialogs.push(b)}});b.realize();b.getModalHeader().addClass("preview-header");b.setData("name","assistant_"+a);b.open()};
