...
$.set_language($(this).data("value"),!1)});$(".layout li a").click(function(){$.set_layout($(this).data("value"))});$(".theme li a").click(function(){$.cookie("theme",$(this).attr("type")+"|"+$(this).attr("rel"),{expires:365,path:"/"});"customer"==$(this).attr("type")?$("#activetheme").attr("href",urlport+window.location.host+"/assets/css/"+$(this).attr("rel")+".css"):"system"==$(this).attr("type")?$("#activetheme").attr("href",urlport+window.location.host+"/systemassets/lukida/css/"+$(this).attr("rel")+
".css"):"bootstrap"==$(this).attr("type")&&$("#activetheme").attr("href",urlport+window.location.host+"/systemassets/bootstrap_3.3.6/css/"+$(this).attr("rel")+".min.css");$("#theme li").removeClass("active");$("#theme [rel='"+$(this).attr("rel")+"']").parent().addClass("active");$.focus_first()});$(window).scroll(function(){Scroll&&$(window).scrollTop()+500>=$(document).height()-$(window).height()&&$.search_next_pack(function(){})});window.scrollTo(0,0);$(".typeahead").typeahead({ajax:"/ajax/getwords",
onSelect:function(a){$.new_search("init",a.value)}});window.onpopstate=function(a){$.close_dialogs();$("#facets").fadeOut("fast").addClass("collapse");$("#results").addClass("collapse");$("#resultsonly").html("");$("#loading").fadeOut("fast").addClass("collapse");null!=a.state&&0<Object.keys(a.state).length?$.facet_search(a.state.text,a.state.facets):($("#start").fadeIn("fast").removeClass("collapse"),$("#searchtext_xs").val(""),$("#searchtext_md").val(""))};$(".yearstart.inlineedit").inlineEdit($('<input name="temp_start" type="text" maxlength="4" size="4" />'),
$("#hiddenyearstart"));$(".yearend.inlineedit").inlineEdit($('<input name="temp_end" type="text" maxlength="4" size="4" />'),$("#hiddenyearend"));$("#hiddenyearstart").change(function(){facetvals.yearminstart=$("#hiddenyearstart").val();facetvals.yearrange="["+facetvals.yearminstart+" TO "+facetvals.yearmaxstart+"]";$.set_facet("year");slider.noUiSlider.set([facetvals.yearminstart,facetvals.yearmaxstart]);void 0!=slider2&&slider2.noUiSlider.set([facetvals.yearminstart,facetvals.yearmaxstart])});$("#hiddenyearend").change(function(){facetvals.yearmaxstart=
$("#hiddenyearend").val();facetvals.yearrange="["+facetvals.yearminstart+" TO "+facetvals.yearmaxstart+"]";$.set_facet("year");slider.noUiSlider.set([facetvals.yearminstart,facetvals.yearmaxstart]);void 0!=slider2&&slider2.noUiSlider.set([facetvals.yearminstart,facetvals.yearmaxstart])});$.focus_first()});
