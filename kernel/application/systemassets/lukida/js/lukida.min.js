...
"typ"==a&&(facetvals[a]=b,facetvals.formats={},$(".numformat").html(""),$("input.facetformat:checkbox").attr("checked",!1),$.new_search("facet_typ"));"format"==a&&(d?(facetvals.formats[b]=d,$.new_search("facet_format_checked")):(delete facetvals.formats[b],$.new_search("facet_format_unchecked")));$.post("/ajax/statsclient",{typ:"Facet",name:a,range:"day"})};$.link_search=function(a,b){""!=b&&(""!=a&&(b="id"!=a?a+"('"+b+"')":a+"("+b+")"),$.close_dialogs(),$.new_search("link",b))};
