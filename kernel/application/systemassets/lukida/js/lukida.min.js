...
{ppnlist:[],language:"",layout:""},favors={},favormails={},favorprint={},idleTimer,time2warn=1080,time2kill=120,timer=!1,urlport=location.protocol+"//",linkresolver=!1;$.is_Empty=function(a){if(null==a)return!0;if(0<a.length)return!1;if(0===a.length||"object"!==typeof a)return!0;for(var b in a)if(hasOwnProperty.call(a,b))return!1;return!0};
$.load_config=function(){$.post("/ajax/config",{screen:JSON.stringify({Width:screen.width,Height:screen.height}),platform:JSON.stringify(platform)},function(a){config=a;$.set_language(config.language,!0);tmp="";$.each(config.datapoolicons,function(a,d){tmp+="<li><a href='javascript:void(0)' data-icon='"+d+"' data-text='"+configlang[("datapool"+a).toUpperCase()]+"' data-value='"+a+"'><i class='"+d+" fa-fw'></i> "+configlang[("datapool"+a).toUpperCase()]+"</a></li>"});$(".facetpool").html(tmp);$(".facetpool li a").click(function(){var a=
...
$.user_message=function(a,b,d){void 0==d&&(d=3E3);if(0<dialogs.length){var c=dialogs[dialogs.length-1].getData("name");"mail"==c&&(c="fullview_"+(dialogs.length-2).toString())}else c=0<results.hits?"results":"statusbar";var e="success"==b?"panel-success":"panel-danger";messid++;$("#"+c+"_messagebar").append($("<div id='message"+messid+"' class='alert-message "+b+"' data-alert></div>"));$("#message"+messid).hide().html("<div class='panel "+e+"'><div class='panel-heading'>"+a+"</div></div>").fadeIn("fast");
$("#message"+messid).delay(d).fadeOut("slow",function(){$(this).remove()})};$.focus_first=function(){768<=$(window).width()?$('[type="text"]:input:enabled:visible:first').focus():$("button:enabled:visible:first").focus()};
$.set_facet=function(a,b,d){"datapool"==a&&(facetvals={datapool:d,iln:"",yearrange:"",yearmin:"",yearmax:"",yearminstart:"",yearmaxstart:"",typ:"total",formats:{}},$.new_search("init",searchvals.text));"iln"==a&&(facetvals={datapool:"",iln:d,yearrange:"",yearmin:"",yearmax:"",yearminstart:"",yearmaxstart:"",typ:"total",formats:{}},$.new_search("init",searchvals.text));"year"==a&&($(".num_TYPTOTAL").html(""),$(".num_TYPPRINT").html(""),$(".num_TYPELECTR").html(""),$('input[name="facetonline"][value=total]').prop("checked",
!0),facetvals.typ="total",facetvals.formats={},$(".numformat").html(""),$("input.facetformat:checkbox").attr("checked",!1),$.new_search("facet_year"));"typ"==a&&(facetvals[a]=b,facetvals.formats={},$(".numformat").html(""),$("input.facetformat:checkbox").attr("checked",!1),$.new_search("facet_typ"));"format"==a&&(d?(facetvals.formats[b]=d,$.new_search("facet_format_checked")):(delete facetvals.formats[b],$.new_search("facet_format_unchecked")));$.post("/ajax/statsclient",{typ:"Facet",name:a,range:"day"})};
...
dataType:"JSON"})).then(function(a){var c="";$.each(a,function(a,b){c+="<button onclick='$.openLink(\""+b+"\")' class='col-xs-12 col-sm-6 col-md-4 btn btn-default btn-exemplar'>"+configlang.FULLTEXT+" ("+configlang[a.toUpperCase()]+")</button>"});""!=c?0<$("#linkresolvercontainer_"+b).length?$("#linkresolvercontainer_"+b).html("<div>"+configlang.ACCESS+"</div><div class='container-fluid'><div class='row'>"+c+"</div></div>"):$("#linkresolver_"+b).html(c):($("#linkresolvercontainer_"+b).html(""),$("#linkresolver_"+
b).html(""))})):($("#linkresolvercontainer_"+b).html(""),$("#linkresolver_"+b).html(""));$.when($.ajax({url:"/ajax/searchsimularpubs/",method:"POST",data:{ppn:a},dataType:"JSON"})).then(function(d){0<d.hitspack?$("#simularpubscontent_"+b).html(d.results):$("#simularpubscontent_"+b).html("<div class='col-xs-12'><div class='well'>"+configlang.NOSIMULARHITS+"</div></div>");$.when($.ajax({url:"/ajax/exportlink/",method:"POST",data:{ppnlist:JSON.stringify(a),format:"zotero"},dataType:"JSON"})).then(function(a){$.each(a,
function(a,b){$(".Z3988").attr("title",b)})})})};$.correctCover=function(a,b){a.onerror="";$(a).replaceWith("<span class='gbvicon'>"+b+"</span>")};
...
configlang.TYPELECTR+"</span></label><span class='num_TYPELECTR numtyp badge counter pull-right'>"+a.online["true"]+"</span></div>");$(".facettyp").change(function(){$.set_facet("typ",$(this).val(),this.checked)});$(".datapool").change(function(){$.set_facet("datapool",$(this).val(),this.checked)});var d="";$.each(a.formats,function(a,b){d+="<div class='checkbox'><label><input class='facetformat' id='"+a.replace(/ /g,"")+"' value='"+a+"' type='checkbox'><span class='lbl_"+a.replace(/ /g,"")+"'>"+
configlang[a.replace(/ /g,"").toUpperCase()]+"</span></label><span class='num_"+a.replace(/ /g,"")+" numformat badge counter pull-right'>"+b+"</span></div>"});$("#formats").html(d);$(".facetformat").change(function(){$.set_facet("format",$(this).val(),this.checked)})};
...
$.open_fullview=function(a,b,d,c){void 0===b&&(b=results.ppnlist);void 0===c&&(c=a);void 0===d&&(d="main");"main"!=d&&(b=jQuery.map(b,function(a,b){return a.toString()}));var e=dialogs.length,f=a in favors?configlang.CHECKLISTREMOVE:configlang.CHECKLIST,h=a in favors?"fa fa-star-o":"fa fa-star",k="publications"==d?$("#related_"+c).html():$("#"+c+" div.panel-heading").html(),g=new BootstrapDialog({message:$('<div id="fullbody_'+e+'"><div class="outercircle"></div><div class="innercircle"></div>').load("/ajax/fullview/"+
a+"/"+e,function(){config.button_checklist&&g.getButton("checklist").prop("disabled",!1);config.button_export&&g.getButton("export").prop("disabled",!1);config.button_mail&&g.getButton("mail").prop("disabled",!1);config.button_print&&g.getButton("print").prop("disabled",!1);$.opened_fullview(a,e)}),title:k,size:BootstrapDialog.SIZE_WIDE,closable:!0,buttons:[{id:"prevbtn",icon:"glyphicon glyphicon-chevron-left",cssClass:"btn-default fullview-button-left",action:function(c){0<b.indexOf(a)?(a=b[b.indexOf(a)-
1],$("#fullbody_"+e).slideUp("fast","swing",function(){$("#fullbody_"+e).load("/ajax/fullview/"+a+"/"+e,function(){"publications"==d?c.getModalHeader().find(".bootstrap-dialog-title").html($("#related_"+a).html()):c.getModalHeader().find(".bootstrap-dialog-title").html($("#"+a+" div.panel-heading").html());$("#fullbody_"+e).slideDown("fast");var b=c.getModalFooter().find(".checklist");a in favors?(b.find(".text").text(configlang.CHECKLISTREMOVE),b.find(".fa").removeClass("fa-star"),b.find(".fa").addClass("fa-star-o")):
...
$.push_state()},onshown:function(){dialogs.push(g);$.is_Empty(statevals)&&(statevals={});$.is_Empty(statevals.ppnlist)&&(statevals.ppnlist=[]);statevals.ppnlist.push({ppn:a,ppnlist:b,typ:d,parentppn:c});$.push_state()}});g.realize();g.getModalHeader().addClass("preview-header");config.button_checklist?g.getButton("checklist").prop("disabled",!0):g.getButton("checklist").hide();config.button_export?g.getButton("export").prop("disabled",!0):g.getButton("export").hide();config.button_mail?g.getButton("mail").prop("disabled",
!0):g.getButton("mail").hide();config.button_print?g.getButton("print").prop("disabled",!0):g.getButton("print").hide();g.setData("ppn",a);g.setData("name","fullview_"+e);g.open()};
...
"json")}}],onhidden:function(){dialogs.pop();""!=d&&$.user_message(c,d);""!=e&&$.user_message(f,e,1E4);b()},onshown:function(){dialogs.push(h);"1"==config.devmode&&($("#kennung").val(config.devuser),$("#passwort").val(config.devpassword));$("#kennung").focus();void 0!=a&&""!=a&&$.user_message(configlang[a],"warning")}});h.realize();h.getModalHeader().addClass("preview-header");h.setData("name","login");h.open()};$.loginonly=function(){$.login("",function(){})};
...
$(".selectdatapool").attr("title",configlang.SELECTDATAPOOL);$(".startsearch").attr("title",configlang.STARTSEARCH);$(".filterresults").attr("title",configlang.RESULTFILTER);$(".selectdiscoverydatapool").find('[value=""]').html(configlang.DATAPOOLGLOBAL);$(".selectdiscoverydatapool").find('[value=""]').attr("data-tokens",configlang.ALL);$(".selectdiscoverydatapool").selectpicker("refresh");$("[data-optgroup='1']").first().find(".text").html(configlang.ALL);"ger"==a&&($("#welcome_eng").addClass("hide"),
$("#welcome_ger").removeClass("hide"));"eng"==a&&($("#welcome_eng").removeClass("hide"),$("#welcome_ger").addClass("hide"));config.language=a;b||$.user_message(configlang.LANGUAGECHANGED,"success");$.focus_first()},"json")};
...
$.reservation=function(a,b,d){var c=b="",e;for(e in d)"action"!=e&&"typ"!=e&&"id"!=e&&""!=d[e]&&(""==c&&(c=e.replace(/\d/g,"")),""!=c&&c!=e.replace(/\d/g,"")&&(c=e.replace(/\d/g,""),b+="<br />"),b+=d[e].replace(/%lt%/g,"&lt;").replace(/%gt%/g,"&gt;")+"<br />");b+='<br /><div id="reservation_messagebar"></div>';e=$("#"+a+" div.panel-heading").html();void 0==e&&(e=$("#related_"+a).html());var f="",h="",k=new BootstrapDialog({message:b,title:e,closable:!0,buttons:[{icon:"glyphicon glyphicon-menu-up",
label:" "+configlang.CANCEL,action:function(a){a.close();$.focus_first()}},{icon:"fa fa-map-marker",label:" "+configlang.RESERVATION,cssClass:"fullview-button-color",action:function(a){""==usrconfig?$.login("LOGINFIRST",function(){$.post("/ajax/request",{uri:d.id},function(b){0>b.status?(f="warning",h=configlang.PROCESSSTOPPED+"<br />"+b.error):(f="success",h=configlang.RESERVATIONSUCCESS);a.close()},"json")}):$.post("/ajax/request",{uri:d.id},function(b){0>b.status?(f="warning",h=configlang.PROCESSSTOPPED+
"<br />"+b.error):(f="success",h=configlang.RESERVATIONSUCCESS);a.close()},"json")}}],onhidden:function(){dialogs.pop();""!=f&&$.user_message(h,f)},onshown:function(){dialogs.push(k)}});k.realize();k.getModalHeader().addClass("preview-header");k.setData("name","reservation");k.open()};
...
label:" "+configlang.CANCEL,action:function(a){a.close();$.focus_first()}},{icon:"fa fa-map-marker",label:" "+configlang.ORDER,cssClass:"fullview-button-color",action:function(a){""==usrconfig?$.login("LOGINFIRST",function(){$.post("/ajax/request",{uri:d.id},function(b){0>b.status?(f="warning",h=configlang.PROCESSSTOPPED+"<br />"+b.error):(f="success",h=configlang.ORDERSUCCESS);a.close()},"json")}):$.post("/ajax/request",{uri:d.id},function(b){0>b.status?(f="warning",h=configlang.PROCESSSTOPPED+"<br />"+
b.error):(f="success",h=configlang.ORDERSUCCESS);a.close()},"json")}}],onhidden:function(){dialogs.pop();""!=f&&$.user_message(h,f)},onshown:function(){dialogs.push(k)}});k.realize();k.getModalHeader().addClass("preview-header");k.setData("name","order");k.open()}};
$.mailorder=function(a,b,d){var c="",e="",f=$("#"+a+" div.panel-heading").html();void 0==f&&(f=$("#related_"+a).html());var h="ORDER",k="MAILORDER",g=new BootstrapDialog({message:$('<div id="mailorderviewbody"></div>').load("/ajax/mailorderview/"+a+"/"+b,function(){void 0!=$("#mailbutton")&&(h=$("#buttontext").attr("value"));void 0!=$("#mailtyp")&&(k=$("#mailtyp").attr("value"))}),title:f,closable:!0,buttons:[{icon:"glyphicon glyphicon-menu-up",label:" "+configlang.CANCEL,action:function(a){a.close();
$.focus_first()}},{icon:"fa fa-map-marker",label:" "+configlang[h.toUpperCase()],cssClass:"fullview-button-color",action:function(b){var f=$("input[name=mailto]:checked").val();void 0==f&&(f=$("#mailto").attr("value"));if(void 0==f)return $.user_message("Die MailTo-Adresse konnte nicht ermittelt werden!","warning"),-1;var g=$("input[name=mailfrom]:checked").val();void 0==g&&(g=$("#mailfrom").attr("value"));if(void 0==g)return $.user_message("Die MailFrom-Adresse konnte nicht ermittelt werden!","warning"),
-1;if(""==usrconfig)$.login("LOGINFIRST",function(){var h={},l=$("input[name=volume]").val();void 0!=l&&(h.volume=l);l=$("#mail_"+(dialogs.length-2)).wrap("<p/>").parent().html();$.post("/ajax/mailorderto",{exemplar:JSON.stringify(d),fullbody:JSON.stringify(l),ppn:a,mailto:f,mailfrom:g,userinput:JSON.stringify(h),mailtyp:k},function(a){0>a.status?$.user_message(configlang.PROCESSSTOPPED+"<br />"+a.error,"warning"):(c="success",e=configlang.ORDERSUCCESS,b.close())},"json")});else{var h={},l=$("input[name=volume]").val();
void 0!=l&&(h.volume=l);l=$("#mail_"+(dialogs.length-2)).wrap("<p/>").parent().html();$.post("/ajax/mailorderto",{exemplar:JSON.stringify(d),fullbody:JSON.stringify(l),ppn:a,mailto:f,mailfrom:g,userinput:JSON.stringify(h),mailtyp:k},function(a){0>a.status?$.user_message(configlang.PROCESSSTOPPED+"<br />"+a.error,"warning"):(c="success",e=configlang.ORDERSUCCESS,b.close())},"json")}}}],onhidden:function(){dialogs.pop();""!=c&&$.user_message(e,c)},onshown:function(){dialogs.push(g)}});g.realize();g.getModalHeader().addClass("preview-header");
g.setData("name","mailorder");g.open()};$.cancel=function(a){$.post("/ajax/cancel",{uri:a},function(a){0>a.status?$.user_message(configlang.PROCESSSTOPPED+"<br />"+a.error,"warning"):$.user_message(configlang.CANCELSUCCESS,"success")},"json")};$.renew=function(a){$.post("/ajax/renew",{uri:a},function(a){$.close_dialogs();$.open_user("userrentals");0>a.status?$.user_message(configlang.PROCESSSTOPPED+"<br />"+a.error,"warning"):$.user_message(configlang.RENEWSUCCESS,"success")},"json")};
...
$.cleanArray=function(a){for(var b=0;b<a.length;b++)void 0==a[b].trim()||""==a[b].trim()?(a.splice(b,1),b--):a[b]=a[b].trim();return a};$.openLink=function(a){$.post("/ajax/statsclient",{typ:"Link",name:a,range:"year"});window.open(a,"_blank")};$.go=function(a){"discover"==a&&(window.location.href=urlport+window.location.host)};
