...
dataType:"JSON"})).then(function(a){var c="";$.each(a,function(a,b){c+="<button onclick='$.openLink(\""+b+"\")' class='col-xs-12 col-sm-6 col-md-4 btn btn-default btn-exemplar'>Volltext ("+configlang[a.toUpperCase()]+")</button>"});""!=c?0<$("#linkresolvercontainer_"+b).length?$("#linkresolvercontainer_"+b).html("<div>"+configlang.ACCESS+"</div><div class='container-fluid'><div class='row'>"+c+"</div></div>"):$("#linkresolver_"+b).html(c):($("#linkresolvercontainer_"+b).html(""),$("#linkresolver_"+
