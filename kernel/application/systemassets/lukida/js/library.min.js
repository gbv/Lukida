...
$jscomp.polyfill("Array.prototype.find",function(a){return a?a:function(a,b){return $jscomp.findInternal(this,a,b).v}},"es6","es3");$jscomp.arrayIteratorImpl=function(a){var c=0;return function(){return c<a.length?{done:!1,value:a[c++]}:{done:!0}}};$jscomp.arrayIterator=function(a){return{next:$jscomp.arrayIteratorImpl(a)}};$jscomp.SYMBOL_PREFIX="jscomp_symbol_";$jscomp.initSymbol=function(){$jscomp.initSymbol=function(){};$jscomp.global.Symbol||($jscomp.global.Symbol=$jscomp.Symbol)};
...
dataType:"JSON",data:{typ:"devicescreens",params:JSON.stringify(params)},success:function(a){void 0!==window.myChart&&window.myChart.destroy();var b=$("#chart");window.myChart=new Chart(b,{type:"bubble",data:a.data,options:{title:a.title,legend:{display:!1}}})}})}else $.open_password()};
