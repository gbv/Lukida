...
$.focus_first=function(){768<=$(window).width()?$('[type="text"]:input:enabled:visible:first').focus():$("button:enabled:visible:first").focus()};$.cleanArray=function(a){for(var d=0;d<a.length;d++)if(void 0==a[d].trim()||""==a[d].trim())a.splice(d,1),d--;return a};
