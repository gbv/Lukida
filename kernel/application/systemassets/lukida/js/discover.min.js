...
$(".facetpool li a span").each(function(){var d=$(this).parent().data("value").toLowerCase();$(this).html(configlang["DATAPOOL"+d.toUpperCase()])});$(".lang_datapool").html(" "+configlang["DATAPOOL"+facetvals.datapool.toUpperCase()]);formatslanguagesort=[];$.each(formats,function(d,e){formatslanguagesort.push({id:d,val:configlang[d.replace(/ /g,"").toUpperCase()]})});formatslanguagesort.sort(function(d,e){d=d.val.toLowerCase();e=e.val.toLowerCase();return d<e?-1:d>e?1:0});"ger"==a&&($(".showeng").addClass("hide"),
$(".showger").removeClass("hide"));"eng"==a&&($(".showeng").removeClass("hide"),$(".showger").addClass("hide"));$.focus_first()},"json");b&&($.user_message(configlang.LANGUAGECHANGED,"success"),$.push_state())};$.mark_check=function(a){$(".check_"+a).each(function(b){$(this).prop("checked",marcCheck)});marcCheck=!marcCheck;$(".btn-check-all").blur()};$.openLink=function(a){$.post("/ajax/statsclient",{typ:"Link",name:a,range:"year"});window.open(a,"_blank")};
...
$("#idFilterValue").editable("getValue","true").idFilterValue;$.each(settings,function(c,d){void 0!=d&&""!=d&&b++});0==b?(SettingsTooltip=!1,b="",$.remove_tooltips(),clearInterval(intervalID)):$.show_tooltips();$(".countSettings").html(b.toString());a()};
...
h=window.open();h.document.write("<html><head><title>"+xtitle+"</title></head><body><p><img src='"+config.printlogo+"' style='max-width:300px;' />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span><b>"+config.softwarename+" - "+urlport+window.location.host+"</b></span></p>");h.document.write("<table>"+$("#biblio_"+e).html()+"</table>");h.document.write("</body></html");h.document.close();h.focus();h.print();h.close()}},{id:"mailbtn_"+e,label:" "+configlang.MAIL,icon:"glyphicon glyphicon-envelope",
cssClass:"btn-default hidden-xs hidden-sm",action:function(h){$(this).blur();favormails[a]="<table>"+$("#biblio_"+e).html()+"</table>";""==usrconfig?$.login("LOGINFIRST",function(){""!=usrconfig&&$.open_mail([a])}):$.open_mail([a])}},{id:"exportbtn_"+e,label:" "+configlang.EXPORT,icon:"glyphicon glyphicon-export",cssClass:"btn-default hidden-xs hidden-sm",action:function(h){$(this).blur();$.open_export([a])}},{id:"checklistbtn_"+e,label:' <span class="text">'+g+"</span>",icon:f,cssClass:"btn-default checklist hidden-xs hidden-sm",
...
favormails[a]="<table>"+$("#biblio_"+e).html()+"</table>",favorprint[a]="<table>"+$("#biblio_"+e).html()+"</table>",$.user_message(configlang.CHECKLISTSUCCESS,"success"),h='<span class="bootstrap-dialog-button-icon fa fa-star-o"></span> <span class="text">'+configlang.CHECKLISTREMOVE+"</span>");$("#checklistbtn_"+e).html(h);$("#checklistbtn_xs_"+e).html(h);$.update_favors()}},{id:"prevbtn_xs_"+e,icon:"glyphicon glyphicon-chevron-left",cssClass:"btn-default fullview-button-left hidden-md hidden-lg col-xs-2 col-sm-1 NoLeftMargin",
action:function(h){$(this).blur();0<b.indexOf(a)?(a=b[b.indexOf(a)-1],$("#fullbody_"+e).slideUp("fast","swing",function(){$.set_fullviewppn(a,e,c,function(){$("#fullbody_"+e).slideDown("fast")})})):$.user_message(configlang.FIRSTOBJECT,"warning")}},{id:"nextbtn_xs_"+e,icon:"glyphicon glyphicon-chevron-right",cssClass:"btn-default fullview-button-left hidden-md hidden-lg col-xs-2 col-sm-1 NoLeftMargin",action:function(h){$(this).blur();"main"==c&&b.indexOf(a)<results.hits-1&&b.indexOf(a)==results.hitscurr-
...
action:function(h){$(this).blur();a in favors?(delete favors[a],delete favormails[a],delete favorprint[a],$.user_message(configlang.CHECKLISTREMOVESUCCESS,"success"),h='<span class="bootstrap-dialog-button-icon fa fa-star"></span> <span class="text">'+configlang.CHECKLIST+"</span>"):(favors[a]=$("#"+a).clone().removeClass("medium col-xs-12 col-sm-6 col-md-4 col-lg-3","col-md-6").addClass("merk col-md-6"),$(favors[a]).find("a").attr("href","javascript:$.open_fullview('"+a+"',Object.keys(favors));"),
favormails[a]="<table>"+$("#biblio_"+e).html()+"</table>",favorprint[a]="<table>"+$("#biblio_"+e).html()+"</table>",$.user_message(configlang.CHECKLISTSUCCESS,"success"),h='<span class="bootstrap-dialog-button-icon fa fa-star-o"></span> <span class="text">'+configlang.CHECKLISTREMOVE+"</span>");$("#checklistbtn_"+e).html(h);$("#checklistbtn_xs_"+e).html(h);$.update_favors()}},{label:" "+configlang.CANCEL,icon:"glyphicon glyphicon-menu-up",cssClass:"btn-default hidden-md hidden-lg col-xs-4 col-sm-2 LeftOffset2",
...
cssClass:"btn-default hidden-md hidden-lg col-xs-3 col-sm-2 NoLeftMargin",action:function(h){$(this).blur();h=window.open();h.document.write("<html><head><title>"+xtitle+"</title></head><body><p><img src='"+config.printlogo+"' style='max-width:300px;' />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span><b>"+config.softwarename+" - "+urlport+window.location.host+"</b></span></p>");h.document.write("<table>"+$("#biblio_"+e).html()+"</table>");h.document.write("</body></html");h.document.close();
h.focus();h.print();h.close()}},{id:"mailbtn_xs_"+e,label:" "+configlang.MAIL,icon:"glyphicon glyphicon-envelope",cssClass:"btn-default hidden-md hidden-lg col-xs-3 col-sm-2 LeftOffset2",action:function(h){$(this).blur();favormails[a]="<table>"+$("#biblio_"+e).html()+"</table>";""==usrconfig?$.login("LOGINFIRST",function(){""!=usrconfig&&$.open_mail([a])}):$.open_mail([a])}}],onhidden:function(){dialogs.pop();$.show_answer();statevals.ppnlist.pop();$.replace_state()},onshown:function(){dialogs.push(l);
$.set_fullviewppn(a,e,c,function(){$.is_Empty(statevals)&&(statevals={});$.is_Empty(statevals.ppnlist)&&(statevals.ppnlist=[]);statevals.ppnlist.push({ppn:a,ppnlist:b,typ:c,parentppn:d})})}});l.realize();l.getModalHeader().addClass("preview-header");l.setData("ppn",a);l.setData("name","fullview_"+e);l.open()};
...
$.open_settings=function(){var a=dialogs.length,b={range:{min:1E3,max:(new Date).getFullYear()},connect:!0,behaviour:"drag",step:1};b.start=void 0!=facetvals.yearminbase&&void 0!=facetvals.yearmaxbase&&""!=facetvals.yearminbase&&""!=facetvals.yearmaxbase?[facetvals.yearminbase,facetvals.yearmaxbase]:[1E3,(new Date).getFullYear()];var c=JSON.stringify(settings),d=facetvals.datapool,e=facetvals.phonetic,g="["+facetvals.yearminbase+" TO "+facetvals.yearmaxbase+"]",f=new BootstrapDialog({message:$('<div id="settings_'+
a+'"></div>').load("/ajax/settings/"+a,function(){}),title:configlang.SETTINGS,size:BootstrapDialog.SIZE_WIDE,closable:!0,buttons:[{icon:"glyphicon glyphicon-menu-up",label:" "+configlang.CANCEL,action:function(k){k.close();$.focus_first()}},{icon:"glyphicon glyphicon-tasks",label:" "+configlang.MORESETTINGS,id:"moresettings",action:function(k){$(this).blur();$.open_filters(function(){$.format_filterboxes()});$.focus_first()}},{id:"loadsettings",icon:"glyphicon glyphicon-open",label:" "+configlang.LOAD,
action:function(k){$(this).blur();settingsname="";""==usrconfig?$.login("LOGINFIRST",function(){""!=usrconfig&&$.open_settingsview(function(){$.setup_settings()})}):$.open_settingsview(function(){$.setup_settings()});$.focus_first()}},{id:"savesettings",icon:"glyphicon glyphicon-save",label:" "+configlang.STORE,action:function(k){$(this).blur();settingsname="";""==usrconfig?$.login("LOGINFIRST",function(){""!=usrconfig&&$.open_settingsstore(function(){""!=settingsname&&$.update_settings(function(){var l=
{settings:settings,facetvals:facetvals};$.post("/ajax/settingsstore",{name:JSON.stringify(settingsname),settings:JSON.stringify(l)},function(h){"0"<=h&&$.user_message(configlang.SETTINGSSTORESUCCESS,"success")})})})}):$.open_settingsstore(function(){""!=settingsname&&$.update_settings(function(){var l={settings:settings,facetvals:facetvals};$.post("/ajax/settingsstore",{name:JSON.stringify(settingsname),settings:JSON.stringify(l)},function(h){"0"<=h&&$.user_message(configlang.SETTINGSSTORESUCCESS,
"success")})})});$.focus_first()}},{icon:"fa fa-eraser",label:" "+configlang.CLEAR,action:function(k){$(this).blur();$("#FlexFilters li").find(".editable").each(function(){$(this).editable("setValue","",!1)});$("#communitylibraries").prop("checked",!1);$("#phoneticSwitch").prop("checked",!1);slider3.noUiSlider.set([1E3,(new Date).getFullYear()]);$.focus_first()}},{icon:"fa fa-check",label:" OK",cssClass:"fullview-button-color",action:function(k){$(this).blur();$.update_settings(function(){facetvals.typ=
"total";facetvals.formats={};facetvals.yearmin=facetvals.yearminbase;facetvals.yearmax=facetvals.yearmaxbase;facetvals.yearminstart=facetvals.yearminbase;facetvals.yearmaxstart=facetvals.yearmaxbase;facetvals.yearrange="["+facetvals.yearminbase+" TO "+facetvals.yearmaxbase+"]";c==JSON.stringify(settings)&&g==facetvals.yearrange&&d==facetvals.datapool&&e==facetvals.phonetic||$.new_search("init",$("#searchtext_md").val());k.close()})}}],onhidden:function(){dialogs.pop();$.show_answer();"undefined"!=
typeof slider3&&slider3.noUiSlider.destroy()},onshow:function(){config.lbs||f.getButton("loadsettings").hide();config.lbs||f.getButton("savesettings").hide()},onshown:function(){slider3=document.getElementById("pubyear3");noUiSlider.create(slider3,b);slider3.style.margin="10px 20px 10px 20px";slider3.noUiSlider.on("update",function(k,l){$(".yearstart2").html(Math.floor(k[0]));$(".yearend2").html(Math.floor(k[1]));facetvals.yearminbase=Math.floor(k[0]);facetvals.yearmaxbase=Math.floor(k[1])});"global"==
...
$(".editable").editable();$(".yearstart2").on("shown",function(k,l){l.input.$input.val($(".yearstart2").html())});$(".yearend2").on("shown",function(k,l){l.input.$input.val($(".yearend2").html())});$(".yearstart2").on("save",function(k,l){facetvals.yearminstart=Math.floor(l.newValue);slider3.noUiSlider.set([facetvals.yearminstart,facetvals.yearmaxstart])});$(".yearend2").on("save",function(k,l){facetvals.yearmaxstart=Math.floor(l.newValue);slider3.noUiSlider.set([facetvals.yearminstart,facetvals.yearmaxstart])});
...
$.open_filters=function(a){var b="<div id='filterbody'><ul class='list-group'>";$.each({title:configlang.TITLE,author:configlang.PARTICIPANTS,subject:configlang.SUBJECT,class:configlang.CLASS,publisher:configlang.PUBLISHER,toc:configlang.TOC,id:configlang.ID,series:configlang.SERIES,isn:configlang.ISN},function(d,e){b+="<li class='list-group-item'>";b+=e;b+="<div class='material-switch pull-right'>";b+="<input id='"+d+"Filter' value='"+d+"' class='"+d+"Filter filter' type='checkbox'";-1<filters.indexOf(d)&&
(b+=" checked");b+=" />";b+="<label for='"+d+"Filter' class='noUi-connect'></label>";b+="</div>";b+="</li>"});b+="</ul></div>";var c=new BootstrapDialog({message:b,title:configlang.MORESETTINGS,size:BootstrapDialog.SIZE_SMALL,closable:!0,buttons:[{icon:"glyphicon glyphicon-menu-up",label:" "+configlang.CANCEL,action:function(d){d.close();$.focus_first()}},{icon:"glyphicon glyphicon-triangle-bottom",label:" "+configlang.OK,cssClass:"fullview-button-color",action:function(d){filters=$("#filterbody").find(".filter:checked").map(function(){return this.value}).get();
a();d.close();$.focus_first()}}],onhidden:function(){dialogs.pop();$.show_answer()},onshown:function(){dialogs.push(c)}});c.realize();c.getModalHeader().addClass("preview-header");c.setData("name","filter");c.open()};
...
configlang.NEWPASSWORD1+'"></div></div><div class="form-group"><label for="passwort" class="col-sm-5 control-label">'+configlang.NEWPASSWORD2+'</label><div class="col-sm-7"><input type="password" class="form-control keyenter" id="newpasswort2" placeholder="'+configlang.NEWPASSWORD2+'"></div></div><div id="password_messagebar"></div></div>',title:configlang.CHANGEPASSWORD,closable:!0,buttons:[{icon:"glyphicon glyphicon-menu-up",label:" "+configlang.CANCEL,action:function(b){b.close();$.focus_first()}},
{icon:"fa fa-repeat",label:" "+configlang.CHANGEPASSWORD,cssClass:"fullview-button-color",id:"changepwbutton",action:function(b){$(this).blur();old=$("#oldpassword").val().trim();new1=$("#newpasswort1").val().trim();new2=$("#newpasswort2").val().trim();if(""==old||""==new1||""==new2)return $.user_message(configlang.REQUIREDALLFIELDS,"warning"),""==old?$("#oldpassword").focus():""==newpasswort1?$("#newpasswort1").focus():$("#newpasswort2").focus(),-1;if(new1!=new2)return $.user_message(configlang.PASSWORDSWRONG,
"warning"),$("#newpasswort1").val(""),$("#newpasswort2").val(""),$("#newpasswort1").focus(),-1;$.close_resolvers();$.post("/ajax/changepw",{old:old,new:new2},function(c){"-2"!=c.status?(b.close(),answer.status="success",answer.message=configlang.PASSWORDSUCCESS):($.user_message(c.error,"warning"),$("#oldpassword").focus())},"json")}}],onhidden:function(){dialogs.pop();$.show_answer()},onshown:function(){dialogs.push(a);$("#oldpassword").focus();$(".keyenter").keypress(function(b){13==b.which&&($(this).blur(),
...
"warning"),""==user?$("#kennung").focus():$("#passwort").focus(),-1;$.close_resolvers();$.post("/ajax/login",{user:user,pw:pw},function(l){"-1"!=l?(k.close(),$(".nologinarea").addClass("hide"),$(".loginarea").removeClass("hide"),usrconfig=l,timer=!0,$.startTimer(),answer.status="success",answer.message=configlang.LOGINSUCCESS.replace("{firstname}",l.firstname).replace("{lastname}",l.lastname),l.message&&(c="warning",d=l.messagetext),l.note&&(e="warning",g=l.note),b()):($.user_message(configlang.LOGINERROR,
"warning"),$("#kennung").focus(),usrconfig="");$.focus_first()},"json")}}],onhidden:function(){dialogs.pop();$.show_answer();""!=c&&$.user_message(d,c,1E4);""!=e&&$.user_message(g,e,1E4)},onshown:function(){dialogs.push(f);"1"==config.devmode&&($("#kennung").val(config.devuser),$("#passwort").val(config.devpassword));$("#kennung").focus();$(".keyenter").keypress(function(k){13==k.which&&($(this).blur(),$("#loginbutton").focus().click())});void 0!=a&&""!=a&&$.user_message(configlang[a],"warning")}});
f.realize();f.getModalHeader().addClass("preview-header");f.setData("name","login");f.open()};$.loginonly=function(){$.login("",function(){})};
$.logout=function(){var a=new BootstrapDialog({message:"<div>"+configlang.LOGOUTREALLY.replace("{system}",config.softwarename)+'<div id="logout_messagebar"></div></div>',title:"Logout "+config.softwarename,closable:!0,buttons:[{icon:"glyphicon glyphicon-menu-up",label:" "+configlang.CANCEL,action:function(b){b.close();$.focus_first()}},{icon:"glyphicon glyphicon-log-out",label:" "+configlang.LOGOUT,cssClass:"fullview-button-color",action:function(b){$.close_resolvers();$.post("/ajax/logout",function(c){b.close();
...
var h="";if($("input[name='counter']").length)if($("input[name='counter']").is(":hidden"))h=$("input[name='counter']:hidden").val();else{if(!$("input[name='counter']").is(":checked")){$.user_message(configlang.SELECTDESK,"warning");return}h=$("input[name='counter']:checked").val()}$.request(a,d.id,configlang.RESERVATIONSUCCESS,h,"reserve",function(m){"warning"==m.status?($.user_message(m.message,m.status),m.message="",m.status=""):l.close()})}}],onhidden:function(){dialogs.pop();$.show_answer()},
...
"";if($("input[name='counter']").length)if($("input[name='counter']").is(":hidden"))h=$("input[name='counter']:hidden").val();else{if(!$("input[name='counter']").is(":checked")){$.user_message(configlang.SELECTDESK,"warning");return}h=$("input[name='counter']:checked").val()}$.request(a,d.id,configlang.ORDERSUCCESS,h,"order",function(m){"warning"==m.status?($.user_message(m.message,m.status),m.message="",m.status=""):l.close()})}}],onhidden:function(){dialogs.pop();$.show_answer()},onshown:function(){dialogs.push(k)}});
...
answer.message=c);g(answer)},"json")};$.getfullbody=function(){var a="",b=dialogs.length;do $("#biblio_"+b).length&&(a=$("#biblio_"+b).html()),b--;while(""==a&&0<=b);return a};
$.mailorder=function(a,b,c,d){a=$("#"+b+" div.panel-heading").html();void 0==a&&(a=$("#related_"+b).html());var e="ORDER",g="MAILORDER",f="Magazinbestellung";$.close_resolvers();var k=new BootstrapDialog({message:$('<div id="mailorderviewbody"></div>').load("/ajax/mailorderview/"+b+"/"+c,function(l,h,m){e=$(l).wrapAll($("<div>")).parent().find("#mailbutton").attr("value").toString();g=$(l).wrapAll($("<div>")).parent().find("#mailtyp").attr("value").toString();f=$(l).wrapAll($("<div>")).parent().find("#mailsubject").attr("value").toString();
k.getButton("mailbtn").html("<span class='bootstrap-dialog-button-icon fa fa-map-marker'></span> "+e)}),title:a,closable:!0,buttons:[{icon:"glyphicon glyphicon-menu-up",label:" "+configlang.CANCEL,action:function(l){l.close();$.focus_first()}},{id:"mailbtn",icon:"fa fa-map-marker",label:" "+configlang.ORDER,cssClass:"fullview-button-color",action:function(l){$(this).blur();var h=$("input[name=mailto]:checked").val(),m=$("input[name=mailto]:checked").parent().text();void 0==h&&(h=$("#mailto").attr("value"));
void 0==m&&(m=$("#mailto").data("label"));if(void 0==h)return $.user_message("Die MailTo-Adresse konnte nicht ermittelt werden!","warning"),-1;var r=$("input[name=mailfrom]:checked").val();void 0==r&&(r=$("#mailfrom").attr("value"));if(void 0==r)return $.user_message("Die MailFrom-Adresse konnte nicht ermittelt werden!","warning"),-1;if(""==usrconfig)$.login("LOGINFIRST",function(){var q={},n=$("input[name=volume]").val();void 0!=n&&(q.volume=n);n=$("#msg").val();void 0==n&&(n=$("input[name=msg]:checked").val());
void 0!=n&&(q.msg=n);n="<table>"+$.getfullbody()+"</table>";$.post("/ajax/mailorderto",{exemplar:JSON.stringify(d),fullbody:JSON.stringify(n),ppn:b,epn:c,mailto:h,mailtoname:m,mailfrom:r,userinput:JSON.stringify(q),mailtyp:g,mailsubject:f,userconfig:JSON.stringify(usrconfig)},function(t){if(0>t.status){if(-3==t.status)return $.user_message(t.error,"warning"),!1;$.user_message(configlang.PROCESSSTOPPED+"<br />"+t.error,"warning")}else answer.status="success",answer.message=configlang.ORDERSUCCESS,
l.close()},"json")});else{var u={},p=$("input[name=volume]").val();void 0!=p&&(u.volume=p);p=$("#msg").val();void 0==p&&(p=$("input[name=msg]:checked").val());void 0!=p&&(u.msg=p);p="<table>"+$.getfullbody()+"</table>";$.post("/ajax/mailorderto",{exemplar:JSON.stringify(d),fullbody:JSON.stringify(p),ppn:b,epn:c,mailto:h,mailtoname:m,mailfrom:r,userinput:JSON.stringify(u),mailtyp:g,mailsubject:f,userconfig:JSON.stringify(usrconfig)},function(q){if(0>q.status){if(-3==q.status)return $.user_message(q.error,
"warning"),!1;$.user_message(configlang.PROCESSSTOPPED+"<br />"+q.error,"warning")}else answer.status="success",answer.message=configlang.ORDERSUCCESS,l.close()},"json")}}}],onhidden:function(){dialogs.pop();$.show_answer()},onshown:function(l){dialogs.push(k)}});k.realize();k.getModalHeader().addClass("preview-header");k.setData("name","mailorder");k.open()};
