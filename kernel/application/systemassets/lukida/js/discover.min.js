...
var Scroll=!1,Height=$(document).height(),title="",user,pw,status,username,mailfrom,mailto,msg,config,usrconfig="",configlang,xtitle=document.title,slider1,slider2,slider3,dialogs=[],waitdialog,messid=0,appstate={first:!0},querystate=!1,results={hits:0,hitspack:0,hitscurr:0,qtime:"",ppnlist:{},spell:{}},searchvals={text:"",last:"",package:1,inittext:"",initfacets:{}},facetvals={datapool:"",iln:"",phonetic:!1,yearrange:"",yearmin:"",yearmax:"",yearminstart:"",yearmaxstart:"",yearminbase:"",yearmaxbase:"",
typ:"total",formats:{},sort:"scoredesc"},statevals={ppnlist:[],language:"",layout:""},favors={},favormails={},favorprint={},idleTimer,time2warn=1080,time2kill=120,timer=!1,maxrenewals=0,urlport=location.protocol+"//",linkresolver=!1,delay=function(){var a=0;return function(b,c){clearTimeout(a);a=setTimeout(b,c)}}(),marcCheck=!0,formate={Article:1,Book:2,Journal:4,Microform:8,Sound_Recording:16,Serial_Volume:32,Musical_Score:64,Mixed_Materials:128,Data_Media:256,Motion_Picture:512,electronic_Resource:1024,
...
$.toggle_area=function(a){$("."+a+"up").toggleClass("collapse");$("."+a+"down").toggleClass("collapse");view.hasOwnProperty(a)||(view[a]=!1);view[a]?$(".discover"+a).slideUp("fast").addClass("collapse"):$(".discover"+a).slideDown("fast").removeClass("collapse");view[a]=!view[a]};$.close_dialogs=function(){for(var a=dialogs.length-1;0<=a;a--)dialogs[a].close()};$.correctCover=function(a,b){a.onerror="";$(a).replaceWith("<span class='gbvicon'>"+b+"</span>")};
...
$("#btn_facets").removeClass("hidden-xs")));Scroll=!1;50==results.hitspack&&(Scroll=!0)}})};$.search_next_pack=function(a){Scroll=!1;$("#loading").removeClass("hideLoading").addClass("displayLoading");searchvals.package++;$.when($.search_results("adddata")).then(function(){$("#loading").removeClass("displayLoading").addClass("hideLoading");a()})};
...
$.spell_suggestion=function(){var a=searchvals.text;if(2<=results.spell.length)for(count=0;count<results.spell.length/2;){if(-1!=searchvals.text.toLowerCase().indexOf(results.spell[2*count])){var b=new RegExp(results.spell[2*count],"ig"),c=results.spell[2*count+1].suggestion[0].word.replace(/\b[a-z]/g,function(a){return a.toUpperCase()});a=a.replace(b,c)}count++}$.user_message(configlang.NOHITS,"warning",3E3);a!=searchvals.text&&$.user_message(configlang.DIDYOUMEAN.replace("{}","<a style='color:red' href='"+
urlport+window.location.host+"/"+a+"'><b>"+a+"</b></a> <span class='fa fa-link'></span>"),"success",15E3)};$.opened_fullview=function(a,b){$.push_state(a);$.linkresolver(a,b,function(){$.simularpublications(a,b,function(){$.exportlink(a,function(){})})});(config.googlecover||config.googlepreview)&&$.googleresolver(b)};
...
success:function(a){var e="";$.each(a,function(a,b){e+="<button onclick='$.openLink(\""+b+"\")' class='col-xs-12 col-sm-6 col-md-4 btn btn-default btn-exemplar'>"+configlang.FULLTEXT+" ("+configlang[a.toUpperCase()]+")</button>"});""!=e?0<$("#linkresolvercontainer_"+b).length?$("#linkresolvercontainer_"+b).html("<div>"+configlang.ACCESS+"</div><div class='container-fluid'><div class='row'>"+e+"</div></div>"):$("#linkresolver_"+b).html(e):($("#linkresolvercontainer_"+b).html(""),$("#linkresolver_"+
b).html(""));c()}})):($("#linkresolvercontainer_"+b).html(""),$("#linkresolver_"+b).html(""),c())};
$.googleresolver=function(a){var b=$("#isbn_"+a).data("isbn");""!=b&&void 0!=b&&$.ajax({url:urlport+"books.google.com/books?bibkeys=ISBN%3A"+b+"&jscmd=viewapi&callback=listEntries",method:"POST",crossDomain:!0,dataType:"jsonp",success:function(b){$.each(b,function(b,c){c.hasOwnProperty("embeddable")&&c.hasOwnProperty("thumbnail_url")&&c.hasOwnProperty("info_url")&&$("#isbn_"+a).html("<a target='_blank' href='"+c.info_url+"'><img src='"+c.thumbnail_url+"' title='"+configlang.GOOGLEBOOKS+"' data-tooltip='tooltip' data-placement='buttom'></a>");
c.hasOwnProperty("preview")&&"partial"==c.preview&&c.hasOwnProperty("preview_url")&&$("#isbn_"+a).append("<p></p><a target='_blank' href='"+c.preview_url+"'><img src='systemassets/lukida/img/google_preview_"+config.language+".gif'></a>")});$("#isbn_"+a).val(b)}})};
...
a+"/"+e,function(){config.button_checklist&&(h.getButton("checklist").prop("disabled",!1),h.getButton("checklist_xs").prop("disabled",!1));config.button_export&&(h.getButton("export").prop("disabled",!1),h.getButton("export_xs").prop("disabled",!1));config.button_mail&&(h.getButton("mail").prop("disabled",!1),h.getButton("mail_xs").prop("disabled",!1));config.button_qrcode&&(h.getButton("qrcode").prop("disabled",!1),h.getButton("qrcode_xs").prop("disabled",!1));config.button_print&&(h.getButton("print").prop("disabled",
!1),h.getButton("print_xs").prop("disabled",!1));$.opened_fullview(a,e)}),title:k,size:BootstrapDialog.SIZE_WIDE,closable:!0,buttons:[{id:"prevbtn",icon:"glyphicon glyphicon-chevron-left",cssClass:"btn-default fullview-button-left hidden-xs hidden-sm",action:function(d){$(this).blur();0<b.indexOf(a)?(a=b[b.indexOf(a)-1],$("#fullbody_"+e).slideUp("fast","swing",function(){$("#fullbody_"+e).load("/ajax/fullview/"+a+"/"+e,function(){"publications"==c?d.getModalHeader().find(".bootstrap-dialog-title").html($("#related_"+
a).html()):d.getModalHeader().find(".bootstrap-dialog-title").html($("#"+a+" div.panel-heading").html());$("#fullbody_"+e).slideDown("fast");var b=d.getModalFooter().find(".checklist");a in favors?(b.find(".text").text(configlang.CHECKLISTREMOVE),b.find(".fa").removeClass("fa-star"),b.find(".fa").addClass("fa-star-o")):(b.find(".text").text(configlang.CHECKLIST),b.find(".fa").removeClass("fa-star-o"),b.find(".fa").addClass("fa-star"));$.opened_fullview(a,e)})})):$.user_message(configlang.FIRSTOBJECT,
...
a).html()):d.getModalHeader().find(".bootstrap-dialog-title").html($("#"+a+" div.panel-heading").html());$("#fullbody_"+e).slideDown("fast");var b=d.getModalFooter().find(".checklist");a in favors?(b.find(".text").text(configlang.CHECKLISTREMOVE),b.find(".fa").removeClass("fa-star"),b.find(".fa").addClass("fa-star-o")):(b.find(".text").text(configlang.CHECKLIST),b.find(".fa").removeClass("fa-star-o"),b.find(".fa").addClass("fa-star"));$.opened_fullview(a,e)})})}):b.indexOf(a)<b.length-1?(a=b[b.indexOf(a)+
1],$("#fullbody_"+e).slideUp("fast","swing",function(){$("#fullbody_"+e).load("/ajax/fullview/"+a+"/"+e,function(){"publications"==c?d.getModalHeader().find(".bootstrap-dialog-title").html($("#related_"+a).html()):d.getModalHeader().find(".bootstrap-dialog-title").html($("#"+a+" div.panel-heading").html());$("#fullbody_"+e).slideDown("fast");var b=d.getModalFooter().find(".checklist");a in favors?(b.find(".text").text(configlang.CHECKLISTREMOVE),b.find(".fa").removeClass("fa-star"),b.find(".fa").addClass("fa-star-o")):
...
icon:g,cssClass:"btn-default checklist hidden-md hidden-lg col-xs-4 col-sm-4 LeftOffset2",action:function(b){$(this).blur();b=$(this);a in favors?(delete favors[a],delete favormails[a],delete favorprint[a],$.user_message(configlang.CHECKLISTREMOVESUCCESS,"success"),b.find(".text").text(configlang.CHECKLIST),b.find(".fa").removeClass("fa-star-o"),b.find(".fa").addClass("fa-star")):(favors[a]=$("#"+a).clone().removeClass("medium col-xs-12 col-sm-6 col-md-4 col-lg-3","col-md-6").addClass("merk col-md-6"),
...
cssClass:"btn-default hidden-md hidden-lg col-xs-3 col-sm-2 LeftOffset2",action:function(b){$(this).blur();favormails[a]=$("#tab1_"+e).wrap("<p/>").parent().html();""==usrconfig?$.login("LOGINFIRST",function(){""!=usrconfig&&$.open_mail([a])}):$.open_mail([a])}}],onhidden:function(){dialogs.pop();statevals.ppnlist.pop();$.push_state()},onshown:function(){dialogs.push(h);$.is_Empty(statevals)&&(statevals={});$.is_Empty(statevals.ppnlist)&&(statevals.ppnlist=[]);statevals.ppnlist.push({ppn:a,ppnlist:b,
typ:c,parentppn:d})}});h.realize();h.getModalHeader().addClass("preview-header");config.button_checklist?(h.getButton("checklist").prop("disabled",!0),h.getButton("checklist_xs").prop("disabled",!0)):(h.getButton("checklist").hide(),h.getButton("checklist_xs").hide());config.button_export?(h.getButton("export").prop("disabled",!0),h.getButton("export_xs").prop("disabled",!0)):(h.getButton("export").hide(),h.getButton("export_xs").hide());config.button_qrcode?(h.getButton("qrcode").prop("disabled",
!0),h.getButton("qrcode_xs").prop("disabled",!0)):(h.getButton("qrcode").hide(),h.getButton("qrcode_xs").hide());config.button_mail?(h.getButton("mail").prop("disabled",!0),h.getButton("mail_xs").prop("disabled",!0)):(h.getButton("mail").hide(),h.getButton("mail_xs").hide());config.button_print?(h.getButton("print").prop("disabled",!0),h.getButton("print_xs").prop("disabled",!0)):(h.getButton("print").hide(),h.getButton("print_xs").hide());h.setData("ppn",a);h.setData("name","fullview_"+e);h.open()};
$.open_settings=function(){var a=dialogs.length,b={range:{min:1E3,max:(new Date).getFullYear()},connect:!0,behaviour:"drag",step:1};b.start=void 0!=facetvals.yearminbase&&void 0!=facetvals.yearmaxbase&&""!=facetvals.yearminbase&&""!=facetvals.yearmaxbase?[facetvals.yearminbase,facetvals.yearmaxbase]:[1E3,(new Date).getFullYear()];var c=JSON.stringify(settings),d=facetvals.datapool,e=facetvals.phonetic,f="["+facetvals.yearminbase+" TO "+facetvals.yearmaxbase+"]",g=new BootstrapDialog({message:$('<div id="settings_'+
...
"total";facetvals.formats={};facetvals.yearmin=facetvals.yearminbase;facetvals.yearmax=facetvals.yearmaxbase;facetvals.yearminstart=facetvals.yearminbase;facetvals.yearmaxstart=facetvals.yearmaxbase;facetvals.yearrange="["+facetvals.yearminbase+" TO "+facetvals.yearmaxbase+"]";c==JSON.stringify(settings)&&f==facetvals.yearrange&&d==facetvals.datapool&&e==facetvals.phonetic||$.new_search("init",$("#searchtext_md").val());a.close()})}}],onhidden:function(){dialogs.pop();"undefined"!=typeof slider3&&
slider3.noUiSlider.destroy()},onshow:function(){config.lbs||g.getButton("loadsettings").hide();config.lbs||g.getButton("savesettings").hide()},onshown:function(){slider3=document.getElementById("pubyear3");noUiSlider.create(slider3,b);slider3.style.margin="10px 20px 10px 20px";slider3.noUiSlider.on("update",function(a,b){$(".yearstart2").html(Math.floor(a[0]));$(".yearend2").html(Math.floor(a[1]));facetvals.yearminbase=Math.floor(a[0]);facetvals.yearmaxbase=Math.floor(a[1])});$("#phoneticSwitch").change(function(){$(this).is(":checked")?
($("#FlexFilters li").find(".editable").each(function(){$(this).editable("setValue","",!1)}),g.getButton("moresettings").prop("disabled",!0),filters=[],$.format_filterboxes()):g.getButton("moresettings").prop("disabled",!1)});"global"==facetvals.datapool&&$("#communitylibraries").prop("checked",!0);1==facetvals.phonetic&&($("#phoneticSwitch").prop("checked",!0),g.getButton("moresettings").prop("disabled",!0));$("#titleFilterValue").html(settings.title);$("#authorFilterValue").html(settings.author);
...
{icon:"glyphicon glyphicon-open",label:" "+configlang.LOAD,cssClass:"fullview-button-color",action:function(a){var d=0,e="";$(".check_settingsload").each(function(a){1==$(this).prop("checked")&&(d++,e=$(this).data("id"))});0==d?$.user_message(configlang.NOOPTION,"warning"):2<=d?$.user_message(configlang.ONLYONEOPTION,"warning"):($.post("/ajax/settingsload",{id:e},function(a){"0"<=a&&(settings=a.settings.settings,facetvals=a.settings.facetvals,b="success",c=configlang.SETTINGSLOADSUCCESS)},"json"),
a.close())}}],onhidden:function(){dialogs.pop();""!=c&&$.user_message(c,b);a()},onshown:function(){$("#settingsname").focus();dialogs.push(d)}});d.realize();d.getModalHeader().addClass("preview-header");d.setData("name","settingsview");d.open()};
...
xtitle+"</title></head><body><p><img src='"+urlport+window.location.host+"/"+config.printlogo+"' style='max-width:300px;' />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span><b>"+config.softwarename+" - "+urlport+window.location.host+"</b></span></p>");for(var b=Object.keys(favorprint),c=0,d=b.length;c<d;c++)a.document.write(favorprint[b[c]]),c<d-1&&a.document.write("<hr>");a.document.write("</body></html");a.document.close();a.focus();a.print();a.close()}}},{id:"mail",icon:"glyphicon glyphicon-envelope",
label:" "+configlang.MAIL,action:function(a){$(this).blur();""==usrconfig?$.login("LOGINFIRST",function(){""!=usrconfig&&$.open_mail(Object.keys(favors))}):$.open_mail(Object.keys(favors))}},{id:"export",icon:"glyphicon glyphicon-export",label:" "+configlang.EXPORT,action:function(a){$(this).blur();$.open_export(Object.keys(favors))}},{icon:"fa fa-eraser",label:" "+configlang.CHECKLISTCLEAR,action:function(c){$(this).blur();favors={};favorprint={};favormail={};a="success";b=configlang.CHECKLISTCLEARSUCCESS;
c.close()}}],onhidden:function(){dialogs.pop();""!=a&&$.user_message(b,a);$.focus_first()},onshown:function(){dialogs.push(c);$.update_favors()}});c.realize();c.getModalHeader().addClass("preview-header");config.button_export||c.getButton("export").hide();config.button_mail||c.getButton("mail").hide();config.button_print||c.getButton("print").hide();c.setData("name","favors");c.open()};
...
a();b.close();$.focus_first()}}],onhidden:function(){dialogs.pop()},onshown:function(){dialogs.push(c)}});c.realize();c.getModalHeader().addClass("preview-header");c.setData("name","filter");c.open()};
...
"/exportfilelist/"+a+"/"+c,"_blank");b.close()}}],onhidden:function(){dialogs.pop()},onshown:function(){dialogs.push(exportdialog)}});exportdialog.realize();exportdialog.getModalHeader().addClass("preview-header");exportdialog.setData("name","export");exportdialog.open()};
...
"warning"),$("#newpasswort1").val(""),$("#newpasswort2").val(""),$("#newpasswort1").focus(),-1;$.post("/ajax/changepw",{old:old,new:new2},function(d){"-2"!=d.status?(c.close(),a="success",b=configlang.PASSWORDSUCCESS):($.user_message(d.error,"warning"),$("#oldpassword").focus())},"json")}}],onhidden:function(){dialogs.pop();""!=a&&$.user_message(b,a)},onshown:function(){dialogs.push(c);$("#oldpassword").focus();$(".keyenter").keypress(function(a){13==a.which&&($(this).blur(),$("#changepwbutton").focus().click())})}});
c.realize();c.getModalHeader().addClass("preview-header");c.setData("name","password");c.open()};
...
$.reservation=function(a,b,c){var d=b="";for(e in c)"action"!=e&&"typ"!=e&&"id"!=e&&""!=c[e]&&(""==d&&(d=e.replace(/\d/g,"")),""!=d&&d!=e.replace(/\d/g,"")&&(d=e.replace(/\d/g,""),b+="<br />"),b+=c[e].replace(/%lt%/g,"&lt;").replace(/%gt%/g,"&gt;")+"<br />");b+='<br /><div id="reservation_messagebar"></div>';var e=$("#"+a+" div.panel-heading").html();void 0==e&&(e=$("#related_"+a).html());var f="",g="",k=new BootstrapDialog({message:b,title:e,closable:!0,buttons:[{icon:"glyphicon glyphicon-menu-up",
...
$.order=function(a,b,c){if(void 0!=c.id){var d=b="";for(e in c)"action"!=e&&"typ"!=e&&"id"!=e&&""!=c[e]&&(""==d&&(d=e.replace(/\d/g,"")),""!=d&&d!=e.replace(/\d/g,"")&&(d=e.replace(/\d/g,""),b+="<br />"),b+=c[e].replace(/%lt%/g,"&lt;").replace(/%gt%/g,"&gt;")+"<br />");b+='<br /><div id="order_messagebar"></div>';var e=$("#"+a+" div.panel-heading").html();void 0==e&&(e=$("#related_"+a).html());var f="",g="",k=new BootstrapDialog({message:b,title:e,closable:!0,buttons:[{icon:"glyphicon glyphicon-menu-up",
