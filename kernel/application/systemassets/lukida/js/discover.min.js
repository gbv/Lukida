...
function(a,b){$(".Z3988").attr("title",b)})})};$.sortRelatedMedia=function(a,b,d){var c=$(a);a=$($(a).find(b),c);a.sort(function(a,b){var c=$(a).find(d).text().toLowerCase(),k=$(b).find(d).text().toLowerCase();return c>k?1:-1});$.each(a,function(a,b){c.append(b)})};
$.searchrelatedmedia=function(a,b,d){$.when($.ajax({url:"/ajax/searchrelatedpubs/",method:"POST",data:{ppnlink:a,search:b},dataType:"JSON"})).then(function(a){0<a.hitspack?$(d).html(a.results):$(d).html("<div class='col-xs-12'><div class='well'>"+configlang.NOSIMULARHITS+"</div></div>")})};$.correctCover=function(a,b){a.onerror="";$(a).replaceWith("<span class='gbvicon'>"+b+"</span>")};
...
size:BootstrapDialog.SIZE_WIDE,closable:!0,buttons:[{id:"prevbtn",icon:"glyphicon glyphicon-chevron-left",cssClass:"btn-default fullview-button-left",action:function(c){$(this).blur();0<b.indexOf(a)?(a=b[b.indexOf(a)-1],$("#fullbody_"+e).slideUp("fast","swing",function(){$("#fullbody_"+e).load("/ajax/fullview/"+a+"/"+e,function(){"publications"==d?c.getModalHeader().find(".bootstrap-dialog-title").html($("#related_"+a).html()):c.getModalHeader().find(".bootstrap-dialog-title").html($("#"+a+" div.panel-heading").html());
$("#fullbody_"+e).slideDown("fast");var b=c.getModalFooter().find(".checklist");a in favors?(b.find(".text").text(configlang.CHECKLISTREMOVE),b.find(".fa").removeClass("fa-star"),b.find(".fa").addClass("fa-star-o")):(b.find(".text").text(configlang.CHECKLIST),b.find(".fa").removeClass("fa-star-o"),b.find(".fa").addClass("fa-star"));$.opened_fullview(a,e)})})):$.user_message(configlang.FIRSTOBJECT,"warning")}},{id:"nextbtn",icon:"glyphicon glyphicon-chevron-right",cssClass:"btn-default fullview-button-left",
action:function(c){$(this).blur();"main"==d&&b.indexOf(a)<results.hits-1&&b.indexOf(a)==results.hitscurr-1?$.search_next_pack(function(){b=results.ppnlist;a=b[b.indexOf(a)+1];$("#fullbody_"+e).slideUp("fast","swing",function(){$("#fullbody_"+e).load("/ajax/fullview/"+a+"/"+e,function(){"publications"==d?c.getModalHeader().find(".bootstrap-dialog-title").html($("#related_"+a).html()):c.getModalHeader().find(".bootstrap-dialog-title").html($("#"+a+" div.panel-heading").html());$("#fullbody_"+e).slideDown("fast");
var b=c.getModalFooter().find(".checklist");a in favors?(b.find(".text").text(configlang.CHECKLISTREMOVE),b.find(".fa").removeClass("fa-star"),b.find(".fa").addClass("fa-star-o")):(b.find(".text").text(configlang.CHECKLIST),b.find(".fa").removeClass("fa-star-o"),b.find(".fa").addClass("fa-star"));$.opened_fullview(a,e)})})}):b.indexOf(a)<b.length-1?(a=b[b.indexOf(a)+1],$("#fullbody_"+e).slideUp("fast","swing",function(){$("#fullbody_"+e).load("/ajax/fullview/"+a+"/"+e,function(){"publications"==d?
c.getModalHeader().find(".bootstrap-dialog-title").html($("#related_"+a).html()):c.getModalHeader().find(".bootstrap-dialog-title").html($("#"+a+" div.panel-heading").html());$("#fullbody_"+e).slideDown("fast");var b=c.getModalFooter().find(".checklist");a in favors?(b.find(".text").text(configlang.CHECKLISTREMOVE),b.find(".fa").removeClass("fa-star"),b.find(".fa").addClass("fa-star-o")):(b.find(".text").text(configlang.CHECKLIST),b.find(".fa").removeClass("fa-star-o"),b.find(".fa").addClass("fa-star"));
...
c.close())})}}],onhidden:function(){dialogs.pop()},onshown:function(){dialogs.push(c);$("#username").focus()}});c.realize();c.getModalHeader().addClass("preview-header");c.setData("name","mail");c.open()}};
...
void 0!=m&&(l.volume=m);m=$("#mail_"+(dialogs.length-2)).wrap("<p/>").parent().html();$.post("/ajax/mailorderto",{exemplar:JSON.stringify(d),fullbody:JSON.stringify(m),ppn:a,mailto:f,mailfrom:g,userinput:JSON.stringify(l),mailtyp:k,mailsubject:h},function(a){0>a.status?$.user_message(configlang.PROCESSSTOPPED+"<br />"+a.error,"warning"):(c="success",e=configlang.ORDERSUCCESS,b.close())},"json")});else{var l={},m=$("input[name=volume]").val();void 0!=m&&(l.volume=m);m=$("#mail_"+(dialogs.length-2)).wrap("<p/>").parent().html();
$.post("/ajax/mailorderto",{exemplar:JSON.stringify(d),fullbody:JSON.stringify(m),ppn:a,mailto:f,mailfrom:g,userinput:JSON.stringify(l),mailtyp:k,mailsubject:h},function(a){0>a.status?$.user_message(configlang.PROCESSSTOPPED+"<br />"+a.error,"warning"):(c="success",e=configlang.ORDERSUCCESS,b.close())},"json")}}}],onhidden:function(){dialogs.pop();""!=c&&$.user_message(e,c)},onshown:function(){dialogs.push(l);g=$("#mailbutton").attr("value").toString();k=$("#mailtyp").attr("value").toString();h=$("#mailsubject").attr("value").toString();
