var Scroll=!1,Height=$(document).height(),title="",user,pw,status,username,mailfrom,mailto,msg,config,usrconfig="",configlang,xtitle=document.title,slider,slider2,dialogs=[],waitdialog,messid=0,appstate={first:!0,pushurl:""!=location.pathname?!1:!0},results={hits:0,hitspack:0,hitscurr:0,qtime:"",ppnlist:{}},searchvals={text:"",last:"","package":1,inittext:"",initfacets:{}},facetvals={datapool:"",iln:"",yearrange:"",yearmin:"",yearmax:"",yearminstart:"",yearmaxstart:"",typ:"total",formats:{}},statevals=
{ppnlist:[],language:"",layout:""},favors={},favormails={},favorprint={},idleTimer,time2warn=1080,time2kill=120,timer=!1,maxrenewals=0,urlport=location.protocol+"//",linkresolver=!1,delay=function(){var a=0;return function(b,c){clearTimeout(a);a=setTimeout(b,c)}}(),marcCheck=!0,formate={Article:1,Book:2,Journal:4,Microform:8,Sound_Recording:16,Serial_Volume:32,Musical_Score:64,Mixed_Materials:128,Data_Media:256,Motion_Picture:512,electronic_Resource:1024,Map:2048,unknown:4096,Game:8192,Manuscript:16384};
$.is_Empty=function(a){if(null==a)return!0;if(0<a.length)return!1;if(0===a.length||"object"!==typeof a)return!0;for(var b in a)if(hasOwnProperty.call(a,b))return!1;return!0};
$.load_config=function(){$.post("/ajax/config",{screen:JSON.stringify({Width:screen.width,Height:screen.height}),platform:JSON.stringify(platform)},function(a){config=a;""!=statevals.language&&(config.language=statevals.language);$.set_language(config.language,!1);""!=statevals.layout&&$.set_layout(statevals.layout,!1);tmp="";$.each(config.datapoolicons,function(a,c){tmp+="<li><a href='javascript:void(0)' data-icon='"+c+"' data-text='"+configlang[("datapool"+a).toUpperCase()]+"' data-value='"+a+"'><i class='"+
c+" fa-fw'></i> <span>"+configlang[("datapool"+a).toUpperCase()]+"</span></a></li>"});$(".facetpool").html(tmp);$(".facetpool li a").click(function(){var a=$(this).data("value").toLowerCase();$(".icon_datapool").html("<i class='"+config.datapoolicons[a]+"'</i>");$(".lang_datapool").html(" "+configlang["DATAPOOL"+a.toUpperCase()]);$.set_facet("datapool","",a)});time2warn=60*config.time2warn;time2kill=60*config.time2kill;maxrenewals=parseInt(config.maxrenewals);0==!usrconfig&&(timer=!0,$.startTimer());
$.is_Empty(searchvals.initfacets)?(appstate.first=!1,facetvals.datapool=config.datapool):(appstate.first=!0,facetvals=searchvals.initfacets,searchvals.initfacets={});$(".facetpool").parents(".dropdown").find(".btn").val(facetvals.datapool);"local"==facetvals.datapool.toLowerCase()?($(".datapoollocal").removeClass("hide"),$(".datapoolglobal").addClass("hide")):($(".datapoollocal").addClass("hide"),$(".datapoolglobal").removeClass("hide"));""!=searchvals.inittext&&$.when($.new_search("initfacets",searchvals.inittext)).done(function(){searchvals.inittext=
""})},"JSON")};
$.user_message=function(a,b,c){void 0==c&&(c=3E3);if(0<dialogs.length){var d=dialogs[dialogs.length-1].getData("name");"mail"==d&&(d="fullview_"+(dialogs.length-2).toString())}else d=0<results.hits?"results":"statusbar";var e="success"==b?"panel-success":"panel-danger";messid++;$("#"+d+"_messagebar").append($("<div id='message"+messid+"' class='alert-message "+b+"' data-alert></div>"));$("#message"+messid).hide().html("<div class='panel "+e+"'><div class='panel-heading'>"+a+"</div></div>").fadeIn("fast");$("#message"+
messid).delay(c).fadeOut("slow",function(){$(this).remove()})};$.focus_first=function(){768<=$(window).width()?$('[type="text"]:input:enabled:visible:first').focus():$("button:enabled:visible:first").focus()};
...
$.link_search=function(a,b){""!=b&&(""!=a&&(b="id"!=a&&"year"!=a?a+"('"+b+"')":a+"("+b.replace(/[^a-z0-9]/gi,"")+")"),$.close_dialogs(),$.new_search("link",b))};
$.init_client=function(a){if(!$.is_Empty(a)){var b={};a.replace(/([^=&]+)=([^&]*)/g,function(a,d,e){b[decodeURIComponent(d)]=decodeURIComponent(e)});void 0!=b.g&&(statevals.language="g"==b.g.substring(0,1)?"ger":"eng",statevals.layout=12/b.g.substring(1,2));void 0!=b.ft&&("2"==b.ft&&(searchvals.initfacets.typ="total"),"1"==b.ft&&(searchvals.initfacets.typ="true"),"0"==b.ft&&(searchvals.initfacets.typ="false"));searchvals.initfacets.yearmin=void 0!=b.fy?parseInt(b.fy.substring(0,4)):"";searchvals.initfacets.yearminstart=
void 0!=b.fy?parseInt(b.fy.substring(4,8)):"";searchvals.initfacets.yearmaxstart=void 0!=b.fy?parseInt(b.fy.substring(8,12)):"";searchvals.initfacets.yearmax=void 0!=b.fy?parseInt(b.fy.substring(12,15)):"";searchvals.initfacets.yearrange=void 0!=b.fy?"["+parseInt(b.fy.substring(4,8))+" TO "+parseInt(b.fy.substring(8,12))+"]":"";void 0!=b.fd&&(searchvals.initfacets.datapool=b.fd);void 0!=b.ff&&0<parseInt(b.ff)&&(searchvals.initfacets.formats={},$.each(formate,function(a){formate[a]&b.ff&&(searchvals.initfacets.formats[a.replace("_",
" ")]=!0)}));appstate.pushurl=!1}};
$.push_state=function(a){a=void 0===a?"":a;var b=urlport+window.location.host;if(""!=a){b+="/id%7Bcolon%7D"+a;appstate.pushurl=!0;var c={};a="id:"+a}else{""==searchvals.text.trim()&&(searchvals.text="*");c=searchvals.text.replace(/"/g,"'").replace(/\*/g,"{star}").replace(/\//g,"{slash}").replace(/</g,"{st}").replace(/>/g,"{gt}").replace(/:/g,"{colon}");b+="/"+encodeURIComponent(c);c="g="+config.language.substring(0,1)+12/config.layout;"true"==facetvals.typ&&(c+="&ft=1");"false"==facetvals.typ&&(c+=
"&ft=0");if("total"==facetvals.typ||""==facetvals.typ)c+="&ft=2";""!=facetvals.yearmin.toString()&&""!=facetvals.yearminstart.toString()&&""!=facetvals.yearmaxstart.toString()&&""!=facetvals.yearmax.toString()&&void 0!=facetvals.yearmin&&void 0!=facetvals.yearminstart&&void 0!=facetvals.yearmaxstart&&void 0!=facetvals.yearmax&&(c+="&fy="+facetvals.yearmin.toString()+facetvals.yearminstart.toString()+facetvals.yearmaxstart.toString()+facetvals.yearmax.toString());var c=c+("&fd="+facetvals.datapool),
d=0;$.each(facetvals.formats,function(a){d|=formate[a.replace(" ","_")]});c+="&ff="+d;b+="/"+c;a=searchvals.text}appstate.pushurl&&(appstate.first?(window.history.replaceState({text:a,sets:c},a.substring(0,20)+" | "+xtitle,b),appstate.first=!1):window.history.pushState({text:a,sets:c},a.substring(0,20)+" | "+xtitle,b));document.title=a+" | "+xtitle};$.navbar_search=function(a){a=$(a).val();$.new_search("init",a)};
...
$("#searchtext_md").val(b);"initfacets"!=a&&(facetvals.yearrange="",facetvals.yearmin="",facetvals.yearmax="",facetvals.yearminstart="",facetvals.yearmaxstart="",facetvals.typ="total",facetvals.formats={},$("#hiddenyearstart").val(""),$("#hiddenyearend").val(""))}Scroll=!1;searchvals["package"]=1;searchvals.search=searchvals.text;$.open_wait();return $.when($.search_results(a)).then(function(){0==results.hits&&$.user_message(configlang.NOHITS,"warning");$.close_wait();appstate.pushurl=!0;$.push_state();
$.focus_first()})};$.search_next_pack=function(a){Scroll=!1;$("#loading").removeClass("hideLoading").addClass("displayLoading");searchvals["package"]++;$.when($.search_results("adddata")).then(function(){$("#loading").removeClass("displayLoading").addClass("hideLoading");a()})};
...
$.opened_fullview=function(a,b){$.push_state(a);linkresolver?(0<$("#linkresolvercontainer_"+b).length?$("#linkresolvercontainer_"+b).html("<div class='container-fluid'><div class='row'><div class='col-xs-12 col-sm-6 col-md-4'><div class='outercircle'></div><div class='innercircle'></div></div></div></div>"):$("#linkresolver_"+b).html("<div class='col-xs-12 col-sm-6 col-md-4'><div class='outercircle'></div><div class='innercircle'></div></div>"),$.when($.ajax({url:"/ajax/linkresolver/",method:"POST",
data:{ppn:a},dataType:"JSON"})).then(function(a){var d="";$.each(a,function(a,b){d+="<button onclick='$.openLink(\""+b+"\")' class='col-xs-12 col-sm-6 col-md-4 btn btn-default btn-exemplar'>"+configlang.FULLTEXT+" ("+configlang[a.toUpperCase()]+")</button>"});""!=d?0<$("#linkresolvercontainer_"+b).length?$("#linkresolvercontainer_"+b).html("<div>"+configlang.ACCESS+"</div><div class='container-fluid'><div class='row'>"+d+"</div></div>"):$("#linkresolver_"+b).html(d):($("#linkresolvercontainer_"+b).html(""),
$("#linkresolver_"+b).html(""))})):($("#linkresolvercontainer_"+b).html(""),$("#linkresolver_"+b).html(""));config.simularpubs&&$.when($.ajax({url:"/ajax/searchsimularpubs/",method:"POST",data:{ppn:a},dataType:"JSON"})).then(function(a){0<a.hitspack?$("#simularpubscontent_"+b).html(a.results):$("#simularpubscontent_"+b).html("<div class='col-xs-12'><div class='well'>"+configlang.NOSIMULARHITS+"</div></div>")});$.when($.ajax({url:"/ajax/exportlink/",method:"POST",data:{ppnlist:JSON.stringify(a),format:"zotero"},
dataType:"JSON"})).then(function(a){$.each(a,function(a,b){$(".Z3988").attr("title",b)})})};
$.sortRelatedMedia=function(a,b,c){a=$((a||window.event).currentTarget);var d=$(a).text(),e=$(a).data("node"),f=$(a).data("sortdirection"),g="desc"==f?"asc":"desc",k=$(b+"_sBDD"),h=$(b+"_sB"),l=$(h).children("#iconInv"),n=$(b);c=$($(b).find(c),n);a.attr("id")!=b.substring(1)+"_sB"&&$(k).find("span").eq(0).text(d+" ");k&&0==$(b).find("#date").length?($(k).hide(),e="#title"):k&&"none"==$(k).css("display")&&$(k).removeAttr("display");$(h).data("node",e);$(h).data("sortdirection",g);"#title"==e?"desc"==
f?$(l).attr({"class":"glyphicon glyphicon-sort-by-alphabet-alt"}):$(l).attr({"class":"glyphicon glyphicon-sort-by-alphabet"}):"desc"==f?$(l).attr({"class":"glyphicon glyphicon-sort-by-order-alt"}):$(l).attr({"class":"glyphicon glyphicon-sort-by-order"});c.sort(function(a,b){var c=$(a).find(e).text().toLowerCase(),d=$(b).find(e).text().toLowerCase();return"desc"==f?c<d?1:-1:c>d?1:-1});$.each(c,function(a,b){n.append(b)})};
$.searchrelatedmedia=function(a,b,c){$.when($.ajax({url:"/ajax/searchrelatedpubs/",method:"POST",data:{ppnlink:a,search:b},dataType:"JSON"})).then(function(a){0<a.hitspack?$(c).html(a.results):$(c).html("<div class='col-xs-12'><div class='well'>"+configlang.NOSIMULARHITS+"</div></div>");if((a=$(c+"_sBDD"))&&0==$(c).find("#date").length){var b=$(c+"_sB"),f=$(b).children("#iconInv");$(a).hide();$(b).data("node","#title");$(b).data("sortdirection","asc");$(f).attr({"class":"glyphicon glyphicon-sort"})}else a&&
"none"==$(a).css("display")&&$(a).removeAttr("display")})};$.correctCover=function(a,b){a.onerror="";$(a).replaceWith("<span class='gbvicon'>"+b+"</span>")};
...
a+"/"+e,function(){config.button_checklist&&h.getButton("checklist").prop("disabled",!1);config.button_export&&h.getButton("export").prop("disabled",!1);config.button_mail&&h.getButton("mail").prop("disabled",!1);config.button_qrcode&&h.getButton("qrcode").prop("disabled",!1);config.button_print&&h.getButton("print").prop("disabled",!1);void 0!=$("#searchrelatedpubs")&&$("#searchrelatedpubs").keyup(function(){delay(function(){var b=$("#searchrelatedpubs").val().trim();$.searchrelatedmedia(a,b,e?"#relatedpubscontent_"+
e:"#relatedpubscontent_0")},1E3)});void 0!=$("#searchrelatedjournals")&&$("#searchrelatedjournals").keyup(function(){delay(function(){var b=$("#searchrelatedjournals").val().trim();$.searchrelatedmedia(a,b,e?"#relatedjournalscontent_"+e:"#relatedjournalscontent_0")},1E3)});void 0!=$("#searchrelatedarticles")&&$("#searchrelatedarticles").keyup(function(){delay(function(){var b=$("#searchrelatedarticles").val().trim();$.searchrelatedmedia(a,b,e?"#relatedarticlescontent_"+e:"#relatedarticlescontent_0")},
1E3)});$.opened_fullview(a,e)}),title:k,size:BootstrapDialog.SIZE_WIDE,closable:!0,buttons:[{id:"prevbtn",icon:"glyphicon glyphicon-chevron-left",cssClass:"btn-default fullview-button-left",action:function(d){$(this).blur();0<b.indexOf(a)?(a=b[b.indexOf(a)-1],$("#fullbody_"+e).slideUp("fast","swing",function(){$("#fullbody_"+e).load("/ajax/fullview/"+a+"/"+e,function(){"publications"==c?d.getModalHeader().find(".bootstrap-dialog-title").html($("#related_"+a).html()):d.getModalHeader().find(".bootstrap-dialog-title").html($("#"+
...
action:function(d){$(this).blur();"main"==c&&b.indexOf(a)<results.hits-1&&b.indexOf(a)==results.hitscurr-1?$.search_next_pack(function(){b=results.ppnlist;a=b[b.indexOf(a)+1];$("#fullbody_"+e).slideUp("fast","swing",function(){$("#fullbody_"+e).load("/ajax/fullview/"+a+"/"+e,function(){"publications"==c?d.getModalHeader().find(".bootstrap-dialog-title").html($("#related_"+a).html()):d.getModalHeader().find(".bootstrap-dialog-title").html($("#"+a+" div.panel-heading").html());$("#fullbody_"+e).slideDown("fast");
var b=d.getModalFooter().find(".checklist");a in favors?(b.find(".text").text(configlang.CHECKLISTREMOVE),b.find(".fa").removeClass("fa-star"),b.find(".fa").addClass("fa-star-o")):(b.find(".text").text(configlang.CHECKLIST),b.find(".fa").removeClass("fa-star-o"),b.find(".fa").addClass("fa-star"));$.opened_fullview(a,e)})})}):b.indexOf(a)<b.length-1?(a=b[b.indexOf(a)+1],$("#fullbody_"+e).slideUp("fast","swing",function(){$("#fullbody_"+e).load("/ajax/fullview/"+a+"/"+e,function(){"publications"==c?
d.getModalHeader().find(".bootstrap-dialog-title").html($("#related_"+a).html()):d.getModalHeader().find(".bootstrap-dialog-title").html($("#"+a+" div.panel-heading").html());$("#fullbody_"+e).slideDown("fast");var b=d.getModalFooter().find(".checklist");a in favors?(b.find(".text").text(configlang.CHECKLISTREMOVE),b.find(".fa").removeClass("fa-star"),b.find(".fa").addClass("fa-star-o")):(b.find(".text").text(configlang.CHECKLIST),b.find(".fa").removeClass("fa-star-o"),b.find(".fa").addClass("fa-star"));
$.opened_fullview(a,e)})})):$.user_message(configlang.LASTOBJECT,"warning")}},{icon:"glyphicon glyphicon-menu-up",label:" "+configlang.CANCEL,action:function(a){a.close();$.focus_first()}},{id:"qrcode",icon:"fa fa-qrcode",label:" "+configlang.QRCODE,action:function(a){$.open_qrcode()}},{id:"print",icon:"fa fa-print",label:" "+configlang.PRINT,action:function(a){$(this).blur();a=window.open();a.document.write("<html><head><title>"+configlang.PRINT+"</title></head><body>");a.document.write($("#mail_"+
e).wrap("<p/>").parent().html());a.document.write("</body></html");a.document.close();a.focus();a.print();a.close()}},{id:"mail",icon:"glyphicon glyphicon-envelope",label:" "+configlang.MAIL,action:function(b){$(this).blur();favormails[a]=$("#mail_"+e).wrap("<p/>").parent().html();""==usrconfig?$.login("LOGINFIRST",function(){""!=usrconfig&&$.open_mail([a])}):$.open_mail([a])}},{id:"export",icon:"glyphicon glyphicon-export",label:" "+configlang.EXPORT,action:function(b){$(this).blur();$.open_export([a])}},
{id:"checklist",icon:g,cssClass:"btn-default checklist",label:' <span class="text">'+f+"</span>",action:function(b){$(this).blur();b=$(this);a in favors?(delete favors[a],delete favormails[a],delete favorprint[a],$.user_message(configlang.CHECKLISTREMOVESUCCESS,"success"),b.find(".text").text(configlang.CHECKLIST),b.find(".fa").removeClass("fa-star-o"),b.find(".fa").addClass("fa-star")):(favors[a]=$("#"+a).clone().removeClass("medium col-xs-12 col-sm-6 col-md-4 col-lg-3","col-md-6").addClass("merk col-md-6"),
$(favors[a]).find("a").attr("href","javascript:$.open_fullview('"+a+"',Object.keys(favors));"),favormails[a]=$("#mail_"+e).wrap("<p/>").parent().html(),favorprint[a]=$("#mail_"+e).wrap("<p/>").parent().html(),$.user_message(configlang.CHECKLISTSUCCESS,"success"),b.find(".text").text(configlang.CHECKLISTREMOVE),b.find(".fa").removeClass("fa-star"),b.find(".fa").addClass("fa-star-o"));$.update_favors()}}],onhidden:function(){dialogs.pop();statevals.ppnlist.pop();$.push_state()},onshown:function(){dialogs.push(h);
$.is_Empty(statevals)&&(statevals={});$.is_Empty(statevals.ppnlist)&&(statevals.ppnlist=[]);statevals.ppnlist.push({ppn:a,ppnlist:b,typ:c,parentppn:d})}});h.realize();h.getModalHeader().addClass("preview-header");config.button_checklist?h.getButton("checklist").prop("disabled",!0):h.getButton("checklist").hide();config.button_export?h.getButton("export").prop("disabled",!0):h.getButton("export").hide();config.button_qrcode?h.getButton("qrcode").prop("disabled",!0):h.getButton("qrcode").hide();config.button_mail?
...
"warning"),$("#newpasswort1").val(""),$("#newpasswort2").val(""),$("#newpasswort1").focus(),-1;$.post("/ajax/changepw",{old:old,"new":new2},function(e){"-2"!=e.status?(c.close(),a="success",b=configlang.PASSWORDSUCCESS):($.user_message(e.error,"warning"),$("#oldpassword").focus())},"json")}}],onhidden:function(){dialogs.pop();""!=a&&$.user_message(b,a);callback()},onshown:function(){dialogs.push(c);$("#oldpassword").focus();$(".keyenter").keypress(function(a){13==a.which&&($(this).blur(),$("#changepwbutton").focus().click())});
...
$.set_layout=function(a,b){config.layout=a;$.post("/ajax/layout",{layout:a},function(a){$("#resultsonly").fadeOut("fast",function(){$("#resultsonly").html(a.results);window.scrollTo(0,0);$.focus_first();$("#resultsonly").fadeIn("fast").removeClass("collapse")})},"json");b&&($.user_message(configlang.VIEWCHANGED.replace("{col}",12/a),"success"),$.push_state())};
...
label:" "+configlang.CANCEL,action:function(a){a.close();$.focus_first()}},{icon:"fa fa-map-marker",label:" "+configlang.RESERVATION,cssClass:"fullview-button-color",action:function(a){$(this).blur();""==usrconfig?$.login("LOGINFIRST",function(){$.post("/ajax/request",{uri:c.id},function(b){if(0>b.status){if(-3==b.status)return $.user_message(b.error,"warning"),!1;f="warning";g=configlang.PROCESSSTOPPED+"<br />"+b.error}else f="success",g=configlang.RESERVATIONSUCCESS;a.close()},"json")}):$.post("/ajax/request",
{uri:c.id},function(b){if(0>b.status){if(-3==b.status)return $.user_message(b.error,"warning"),!1;f="warning";g=configlang.PROCESSSTOPPED+"<br />"+b.error}else f="success",g=configlang.RESERVATIONSUCCESS;a.close()},"json")}}],onhidden:function(){dialogs.pop();""!=f&&$.user_message(g,f)},onshown:function(){dialogs.push(k)}});k.realize();k.getModalHeader().addClass("preview-header");k.setData("name","reservation");k.open()};
...
label:" "+configlang.CANCEL,action:function(a){a.close();$.focus_first()}},{icon:"fa fa-map-marker",label:" "+configlang.ORDER,cssClass:"fullview-button-color",action:function(a){$(this).blur();""==usrconfig?$.login("LOGINFIRST",function(){$.post("/ajax/request",{uri:c.id},function(b){if(0>b.status){if(-3==b.status)return $.user_message(b.error,"warning"),!1;f="warning";g=configlang.PROCESSSTOPPED+"<br />"+b.error}else f="success",g=configlang.ORDERSUCCESS;a.close()},"json")}):$.post("/ajax/request",
{uri:c.id},function(b){if(0>b.status){if(-3==b.status)return $.user_message(b.error,"warning"),!1;f="warning";g=configlang.PROCESSSTOPPED+"<br />"+b.error}else f="success",g=configlang.ORDERSUCCESS;a.close()},"json")}}],onhidden:function(){dialogs.pop();""!=f&&$.user_message(g,f)},onshown:function(){dialogs.push(k)}});k.realize();k.getModalHeader().addClass("preview-header");k.setData("name","order");k.open()}};
...
void 0!=m&&(l.volume=m);m=$("#mail_"+(dialogs.length-2)).wrap("<p/>").parent().html();$.post("/ajax/mailorderto",{exemplar:JSON.stringify(c),fullbody:JSON.stringify(m),ppn:a,mailto:f,mailfrom:g,userinput:JSON.stringify(l),mailtyp:k,mailsubject:h},function(a){if(0>a.status){if(-3==a.status)return $.user_message(a.error,"warning"),!1;$.user_message(configlang.PROCESSSTOPPED+"<br />"+a.error,"warning")}else d="success",e=configlang.ORDERSUCCESS,b.close()},"json")});else{var l={},m=$("input[name=volume]").val();
void 0!=m&&(l.volume=m);m=$("#mail_"+(dialogs.length-2)).wrap("<p/>").parent().html();$.post("/ajax/mailorderto",{exemplar:JSON.stringify(c),fullbody:JSON.stringify(m),ppn:a,mailto:f,mailfrom:g,userinput:JSON.stringify(l),mailtyp:k,mailsubject:h},function(a){if(0>a.status){if(-3==a.status)return $.user_message(a.error,"warning"),!1;$.user_message(configlang.PROCESSSTOPPED+"<br />"+a.error,"warning")}else d="success",e=configlang.ORDERSUCCESS,b.close()},"json")}}}],onhidden:function(){dialogs.pop();
""!=d&&$.user_message(e,d)},onshown:function(){dialogs.push(l);g=$("#mailbutton").attr("value").toString();k=$("#mailtyp").attr("value").toString();h=$("#mailsubject").attr("value").toString();l.getButton("mailbtn").html("<span class='bootstrap-dialog-button-icon fa fa-map-marker'></span> "+g)}});l.realize();l.getModalHeader().addClass("preview-header");l.setData("name","mailorder");l.open()};
$.cancel=function(a){$.post("/ajax/cancel",{uri:a},function(a){if(0>a.status){if(-3==a.status)return $.user_message(a.error,"warning"),!1;$.user_message(configlang.PROCESSSTOPPED+"<br />"+a.error,"warning")}else $.user_message(configlang.CANCELSUCCESS,"success")},"json")};
...
b).html("")):($("#status_renew_"+b).html('<font color="green"><i class="fa fa-check" aria-hidden="true"></i></font>'),$("#return_renew_"+b).html(a.endtime),0<maxrenewals?($("#renewals_renew_"+b).html(a.renewals+" / "+maxrenewals),parseInt(a.renewals)>=maxrenewals&&$("#checkbox_renew_"+b).html("")):$("#renewals_renew_"+b).html(a.renewals))},"json")}});$(".btn-renew").blur()};$.mark_check=function(a){$(".check_"+a).each(function(a){$(this).prop("checked",marcCheck)});marcCheck=!marcCheck;$(".btn-check-all").blur()};
...
window.scrollTo(0,0);var a=$(".typeahead");a.typeahead({source:function(a,c){if(void 0==a||""==a.trim())return c({});$.get("/ajax/getwords",{query:a},function(a){return c(a)},"json")},autoSelect:!1,delay:300,afterSelect:function(a){$.new_search("init",a)}});a.keydown(function(a){if(13==a.keyCode||9==a.keyCode){a=$(this).val().trim();var c=$(this).typeahead("getActive");c?(c=c.trim(),c==a?$.new_search("init",a):0<$(".navbar:visible ul.typeahead.dropdown-menu").find("li.active").length?$.new_search("init",
$("ul.typeahead.dropdown-menu:visible").find("li.active a").html().replace(/(<([^>]+)>)/ig,"").trim()):$.new_search("init",a)):$.new_search("init",a);event.preventDefault()}});window.onpopstate=function(a){$.close_dialogs();$("#facets").fadeOut("fast").addClass("collapse");$("#results").addClass("collapse");$("#resultsonly").html("");$("#loading").fadeOut("fast").addClass("collapse");null!=a.state&&0<Object.keys(a.state).length?($.init_client(a.state.sets),appstate.first=!0,$.new_search("initfacets",
a.state.text),document.title=a.state.text+" | "+xtitle):($("#start").fadeIn("fast").removeClass("collapse"),$("#searchtext_xs").val(""),$("#searchtext_md").val(""))};$(".yearstart.inlineedit").inlineEdit($('<input name="temp_start" type="number" min="1000" max="9999" />'),$("#hiddenyearstart"));$(".yearend.inlineedit").inlineEdit($('<input name="temp_end" type="number" min="1000" max="9999" />'),$("#hiddenyearend"));$("#hiddenyearstart").change(function(){facetvals.yearminstart=$("#hiddenyearstart").val();
...
void 0!=slider2&&slider2.noUiSlider.set([facetvals.yearminstart,facetvals.yearmaxstart])});$.focus_first()});
