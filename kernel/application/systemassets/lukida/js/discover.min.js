...
success:function(d){var e="";$.each(d,function(h,l){e+="<button onclick='$.openLink(\""+l+"\")' class='"+linkresolverclass+" btn btn-default btn-exemplar'>"+configlang.FULLTEXT+" ("+configlang[h.toUpperCase()]+")</button>"});""!=e?0<$("#linkresolvercontainer_"+b).length?$("#linkresolvercontainer_"+b).html("<div>"+configlang.ACCESS+"</div><div class='container-fluid'><div class='row'>"+e+"</div></div>"):$("#linkresolver_"+b).html(e):($("#linkresolvercontainer_"+b).html(""),$("#linkresolver_"+b).html(""));
