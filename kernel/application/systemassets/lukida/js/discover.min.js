...
Motion_Picture:256,Monograph_Series:512,Manuscript:1024,unknown:2048,Game:4096,Data_Media:8192,Projected_Medium:16384,Mixed_Materials:32768,Picture:65536,electronic_Resource:131072},formats={Article:!1,Book:!1,Journal:!1,"Serial Volume":!1,"Sound Recording":!1,"Musical Score":!1,Microform:!1,Map:!1,"Motion Picture":!1,"Monograph Series":!1,Manuscript:!1,unknown:!1,Game:!1,"Data Media":!1,"Projected Medium":!1,"Mixed Materials":!1,Picture:!1,"electronic Resource":!1},formatslanguagesort=[],view={},
filters=[],settings={title:"",author:"",subject:"",class:"",publisher:"",toc:"",id:"",series:"",isn:""},settingsname,isMobile=window.matchMedia("only screen and (max-width: 760px)").matches,intervalID="",$JSONData,answer={status:"",message:""},resolver={fullview:null,google:null,link:null,simular:null,export:null},SettingsTooltip=!1;$.is_Empty=function(a){if(null==a)return!0;if(0<a.length)return!1;if(0===a.length||"object"!==typeof a)return!0;for(var b in a)if(hasOwnProperty.call(a,b))return!1;return!0};
$.focus_first=function(){};$.show_tooltips=function(){SettingsTooltip=!0;$(".countSettings").tooltip("show");setTimeout($.remove_tooltips,4E3);intervalID=setInterval(function(){$(".countSettings").animate({opacity:"0.5"}).delay(1E3).animate({opacity:"1"})},3E3)};$.remove_tooltips=function(){$(".countSettings").tooltip("hide");$(".countFavors").tooltip("hide")};$.close_wait=function(){waitdialog.close()};$.openInNewTab=function(a){window.open(a,"_blank").focus()};$.validateEmail=function(a){return/^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/.test(a)};
...
$.show_message=function(a,b,c,e){var d="success"==b?"panel-success":"panel-danger";messid++;$("#"+e+"_messagebar").append($("<div id='message"+messid+"' class='alert-message "+b+"' data-alert></div>"));$("#message"+messid).hide().html("<div class='panel "+d+"'><div class='panel-heading'>"+a+"</div></div>").fadeIn("fast");$("#message"+messid).delay(c).fadeOut("slow",function(){$(this).remove()})};
$.set_layout=function(a,b){config.layout=a;$.post("/ajax/layout",{layout:a},function(a){$("#resultsonly").fadeOut("fast",function(){$("#resultsonly").html(a.results);window.scrollTo(0,0);$.focus_first();$("#resultsonly").fadeIn("fast").removeClass("collapse")})},"json");b&&($.user_message(configlang.VIEWCHANGED.replace("{col}",12/a),"success"),$.push_state())};$.show_answer=function(){""!=answer.message&&$.user_message(answer.message,answer.status);answer.message="";answer.status=""};
...
$(".lbl_facetformat").html(configlang.FACETFORMAT);$(".lbl_typtotal").html(configlang.TYPTOTAL);$(".lbl_typprint").html(configlang.TYPPRINT);$(".lbl_typelectr").html(configlang.TYPELECTR);$(".lbl_year").html(configlang.YEAR);$(".lbl_score").html(configlang.SCORE);$(".lbl_sorting").html(configlang.SORTING);$(".imprint").html(configlang.IMPRINT);$(".about").html(configlang.ABOUT);$(".dataprotection").html(configlang.DATAPROTECTION);$.each($(".facetformat"),function(){$(".lbl_"+this.id.replace(/ /g,
"").toUpperCase()).html(configlang[this.id.replace(/ /g,"").toUpperCase()])});$(".ubinfo").attr("title",configlang.INFORMATIONS);$(".myarea").attr("title",configlang.MYAREA);$(".myarea2").html('<i class="fa fa-user"></i> '+configlang.MYAREA);$(".usercollectables").html(configlang.USERCOLLECTABLES);$(".userrentals").html(configlang.USERRENTALS);$(".userorders").html(configlang.USERORDERS);$(".userreservations").html(configlang.USERRESERVATIONS);$(".userfees").html(configlang.USERFEES);$(".usersearches").html(configlang.USERSEARCHES);
$(".userstore").html('<i class="glyphicon glyphicon-save"></i> '+configlang.USERSTORE);$(".favorites").attr("title",configlang.CHECKLIST);$(".selectview").attr("title",configlang.SELECTVIEW);$(".selectlanguage").attr("title",configlang.SELECTLANGUAGE);$(".selectdatapool").attr("title",configlang.SELECTDATAPOOL);$(".startsearch").attr("title",configlang.STARTSEARCH);$(".settings").attr("title",configlang.SETTINGS);$(".filterresults").attr("title",configlang.RESULTFILTER);$(".countSettings").attr("title",
configlang.SETTINGSACTIVE);$(".countSettings").attr("data-original-title",configlang.SETTINGSACTIVE).tooltip("fixTitle");SettingsTooltip&&$.show_tooltips();$(".selectdiscoverydatapool").length&&($(".selectdiscoverydatapool").find('[value=""]').html(configlang.DATAPOOLGLOBAL),$(".selectdiscoverydatapool").find('[value=""]').attr("data-tokens",configlang.ALL),$(".selectdiscoverydatapool").selectpicker("refresh"),$("[data-optgroup='1']").first().find(".text").html(configlang.ALL));$(".facetpool li a span").each(function(){var a=
$(this).parent().data("value").toLowerCase();$(this).html(configlang["DATAPOOL"+a.toUpperCase()])});$(".lang_datapool").html(" "+configlang["DATAPOOL"+facetvals.datapool.toUpperCase()]);formatslanguagesort=[];$.each(formats,function(a,b){formatslanguagesort.push({id:a,val:configlang[a.replace(/ /g,"").toUpperCase()]})});formatslanguagesort.sort(function(a,b){a=a.val.toLowerCase();b=b.val.toLowerCase();return a<b?-1:a>b?1:0});"ger"==a&&($(".showeng").addClass("hide"),$(".showger").removeClass("hide"));
"eng"==a&&($(".showeng").removeClass("hide"),$(".showger").addClass("hide"));$.focus_first()},"json");b&&($.user_message(configlang.LANGUAGECHANGED,"success"),$.push_state())};$.mark_check=function(a){$(".check_"+a).each(function(a){$(this).prop("checked",marcCheck)});marcCheck=!marcCheck;$(".btn-check-all").blur()};$.openLink=function(a){$.post("/ajax/statsclient",{typ:"Link",name:a,range:"year"});window.open(a,"_blank")};
$.toggle_area=function(a){$(":focus").blur();$("."+a+"up").toggleClass("collapse");$("."+a+"down").toggleClass("collapse");view.hasOwnProperty(a)||(view[a]=!1);view[a]?$(".discover"+a).slideUp("fast").addClass("collapse"):$(".discover"+a).slideDown("fast").removeClass("collapse");view[a]=!view[a]};$.close_dialogs=function(){for(var a=dialogs.length-1;0<=a;a--)dialogs[a].close()};$.correctCover=function(a,b){a.onerror="";$(a).replaceWith("<span class='gbvicon'>"+b+"</span>")};
$.init_client=function(a){if(!$.is_Empty(a)){var b={};a.replace(/([^=&]+)=([^&]*)/g,function(a,e,d){b[decodeURIComponent(e)]=decodeURIComponent(d)});void 0!=b.g&&(statevals.language="g"==b.g.substring(0,1)?"ger":"eng",statevals.layout=12/b.g.substring(1,2));void 0!=b.ft&&("2"==b.ft&&(searchvals.initfacets.typ="total"),"1"==b.ft&&(searchvals.initfacets.typ="true"),"0"==b.ft&&(searchvals.initfacets.typ="false"));void 0!=b.fs&&("0"==b.fs&&(searchvals.initfacets.sort="scoredesc"),"1"==b.fs&&(searchvals.initfacets.sort=
...
$.url_clean=function(a){return encodeURIComponent(a.replace(/"/g,"%22").replace(/\//g,"{slash}").replace(/</g,"{st}").replace(/>/g,"{gt}").replace(/:/g,"{colon}").replace(/\*/g,"{star}").replace(/!/g,""))};
...
$.link_search=function(a,b){""!=b&&("foreignid"==a?b=a+"("+$.trim(b).trim("'")+")":"id"==a||"ppnlink"==a?b="id"!=a&&"year"!=a?a+"("+b+")":a+"("+b.replace(/[^a-z0-9]/gi,"")+")":"text"!=a&&(b="id"!=a&&"year"!=a?a+"('"+b+"')":a+"("+b.replace(/[^a-z0-9]/gi,"")+")"),$.close_dialogs(),$.new_search("link",b))};$.navbar_search=function(a){a=$(a).val();$.new_search("init",a)};
$.spell_suggestion=function(){var a=searchvals.search;if(2<=results.spell.length)for(count=0;count<results.spell.length/2;){if(-1!=searchvals.text.toLowerCase().indexOf(results.spell[2*count])){var b=new RegExp(results.spell[2*count],"ig"),c=results.spell[2*count+1].suggestion[0].word.replace(/\b[a-z]/g,function(a){return a.toUpperCase()});a=a.replace(b,c)}count++}"0"!=results.status?$.user_message(configlang.INDEXERROR.replace("{status}",results.status),"warning",5E3):($.user_message(configlang.NOHITS,
"warning",5E3),"local"==facetvals.datapool&&(b=urlport+window.location.host,c=""==searchvals.text.trim()?"{no}":searchvals.text,b+="/"+$.url_clean(c)+"/fd=global",$.user_message(configlang.SEARCHGLOBAL.replace("{}","<a style='color:red' href=\""+b+'"><b>'+configlang.DATAPOOLGLOBAL+"</b></a> <span class='fa fa-link'></span>"),"success",15E3)));a!=searchvals.text&&$.user_message(configlang.DIDYOUMEAN.replace("{}","<a style='color:red' href=\""+urlport+window.location.host+"/"+a+'"><b>'+a+"</b></a> <span class='fa fa-link'></span>"),
"success",15E3)};$.close_resolvers=function(){null!=resolver.fullview&&(resolver.fullview.abort(),resolver.fullview=null);null!=resolver.google&&(resolver.google.abort(),resolver.google=null);null!=resolver.link&&(resolver.link.abort(),resolver.link=null);null!=resolver.simular&&(resolver.simular.abort(),resolver.simular=null);null!=resolver.export&&(resolver.export.abort(),resolver.export=null)};
...
c.thumbnail_url+"' title='"+configlang.GOOGLEBOOKS+"' data-tooltip='tooltip' data-placement='buttom'></a>");c.hasOwnProperty("preview")&&"partial"==c.preview&&c.hasOwnProperty("preview_url")&&$("#isbn_"+a).append("<p></p><a target='_blank' href='"+c.preview_url+"'><img src='systemassets/lukida/img/google_preview_"+config.language+".gif'></a>")});$("#isbn_"+a).val(c);b()}}):b()}else b()};
...
success:function(a){var d="";$.each(a,function(a,b){d+="<button onclick='$.openLink(\""+b+"\")' class='"+linkresolverclass+" btn btn-default btn-exemplar'>"+configlang.FULLTEXT+" ("+configlang[a.toUpperCase()]+")</button>"});""!=d?0<$("#linkresolvercontainer_"+b).length?$("#linkresolvercontainer_"+b).html("<div>"+configlang.ACCESS+"</div><div class='container-fluid'><div class='row'>"+d+"</div></div>"):$("#linkresolver_"+b).html(d):($("#linkresolvercontainer_"+b).html(""),$("#linkresolver_"+b).html(""));
c()}})):($("#linkresolvercontainer_"+b).html(""),$("#linkresolver_"+b).html(""),c())};$.simularpublications=function(a,b,c){config.simularpubs?resolver.simular=$.ajax({url:"/ajax/searchsimularpubs/",method:"POST",data:{ppn:a},dataType:"JSON",success:function(a){0<a.hitspack?$("#simularpubscontent_"+b).html(a.results):$("#simularpubscontent_"+b).html("<div class='col-xs-12'><div class='well'>"+configlang.NOSIMULARHITS+"</div></div>");c()}}):c()};
$.exportlink=function(a,b){resolver.export=$.ajax({url:"/ajax/exportlink/",method:"POST",data:{ppnlist:JSON.stringify(a),format:"zotero"},dataType:"JSON",success:function(a){$.each(a,function(a,b){$(".Z3988").attr("title",b)});b()}})};
...
$.create_facets_formats=function(){var a="",b="",c="",e="",d="",h=Math.ceil(formatslanguagesort.length/2);$.each(formatslanguagesort,function(f,g){valcount=void 0!==$JSONData.formats[g.id]?$JSONData.formats[g.id]:"";b=g.val;a="<div class='checkbox'><label><input class='facetformat' id='"+g.id+"' value='"+g.id+"' type='checkbox'><span class='lbl_"+g.id.replace(/ /g,"").toUpperCase()+"'>"+b+"</span></label><span class='num_"+g.id.replace(/ /g,"").toUpperCase()+" numformat badge counter pull-right'>"+
valcount+"</span></div>";c+=a;b=12<g.val.length?g.val.substring(0,12)+".":g.val;a="<div class='checkbox'><label><input class='facetformat' id='"+g.id+"' value='"+g.id+"' type='checkbox'><span class='lbl_"+g.id.replace(/ /g,"").toUpperCase()+"'>"+b+"</span></label><span class='num_"+g.id.replace(/ /g,"").toUpperCase()+" numformat badge counter pull-right'>"+valcount+"</span></div>";f<h?e+=a:d+=a});$("#formats1").html(c);$("#formats2").html("<div class='row'><div class='col-xs-6'>"+e+"</div><div class='col-xs-6'>"+
d+"</div></div>");$.each(facetvals.formats,function(a,b){$("#formats1").find("input[value='"+a+"']").prop("checked",!0);$("#formats2").find("input[value='"+a+"']").prop("checked",!0)});$(".facetformat").change(function(){"formats1"==$(this).closest(".formats").attr("id")&&$("#formats2").find("input[value='"+$(this).val()+"']").prop("checked",this.checked);"formats2"==$(this).closest(".formats").attr("id")&&$("#formats1").find("input[value='"+$(this).val()+"']").prop("checked",this.checked);$.set_facet("format",
...
$("#idFilterValue").editable("getValue","true").idFilterValue;$.each(settings,function(a,e){void 0!=e&&""!=e&&b++});0==b?(SettingsTooltip=!1,b="",$.remove_tooltips(),clearInterval(intervalID)):$.show_tooltips();$(".countSettings").html(b.toString());a()};
...
$.open_fullview=function(a,b,c,e){void 0===b&&(b=results.ppnlist);void 0===e&&(e=a);void 0===c&&(c="main");"main"!=c&&(b=jQuery.map(b,function(a,b){return a.toString()}));var d=dialogs.length,h=a in favors?configlang.CHECKLISTREMOVE:configlang.CHECKLIST,f=a in favors?"fa fa-star-o":"fa fa-star",g="publications"==c?$("#related_"+e).html():$("#"+e+" div.panel-heading").html(),l=new BootstrapDialog({message:'<div id="fullbody_'+d+'"><div class="outercircle"></div><div class="innercircle"></div></div>',
title:'<div id="fullheader_'+d+'">'+g+"</div>",size:BootstrapDialog.SIZE_WIDE,closable:!0,buttons:[{id:"prevbtn",icon:"glyphicon glyphicon-chevron-left",cssClass:"btn-default fullview-button-left hidden-xs hidden-sm",action:function(e){$(this).blur();0<b.indexOf(a)?(a=b[b.indexOf(a)-1],$("#fullbody_"+d).slideUp("fast","swing",function(){$.set_fullviewppn(a,d,c,function(){$("#fullbody_"+d).slideDown("fast")})})):$.user_message(configlang.FIRSTOBJECT,"warning")}},{id:"nextbtn",icon:"glyphicon glyphicon-chevron-right",
cssClass:"btn-default fullview-button-left hidden-xs hidden-sm",action:function(e){$(this).blur();"main"==c&&b.indexOf(a)<results.hits-1&&b.indexOf(a)==results.hitscurr-1?$.search_next_pack(function(){b=results.ppnlist;a=b[b.indexOf(a)+1];$("#fullbody_"+d).slideUp("fast","swing",function(){$.set_fullviewppn(a,d,c,function(){$("#fullbody_"+d).slideDown("fast")})})}):b.indexOf(a)<b.length-1?(a=b[b.indexOf(a)+1],$("#fullbody_"+d).slideUp("fast","swing",function(){$.set_fullviewppn(a,d,c,function(){$("#fullbody_"+
d).slideDown("fast")})})):$.user_message(configlang.LASTOBJECT,"warning")}},{label:" "+configlang.CANCEL,icon:"glyphicon glyphicon-menu-up",cssClass:"btn-default hidden-xs hidden-sm",action:function(a){a.close();$.focus_first()}},{id:"qrcodebtn_"+d,label:" "+configlang.QRCODE,icon:"fa fa-qrcode",cssClass:"btn-default hidden-xs hidden-sm",action:function(a){$(this).blur();$.open_qrcode()}},{id:"printbtn_"+d,label:" "+configlang.PRINT,icon:"fa fa-print",cssClass:"btn-default hidden-xs hidden-sm",action:function(a){$(this).blur();
a=window.open();a.document.write("<html><head><title>"+xtitle+"</title></head><body><p><img src='"+config.printlogo+"' style='max-width:300px;' />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span><b>"+config.softwarename+" - "+urlport+window.location.host+"</b></span></p>");a.document.write("<table>"+$("#biblio_"+d).html()+"</table>");a.document.write("</body></html");a.document.close();a.focus();a.print();a.close()}},{id:"mailbtn_"+d,label:" "+configlang.MAIL,icon:"glyphicon glyphicon-envelope",
cssClass:"btn-default hidden-xs hidden-sm",action:function(b){$(this).blur();favormails[a]="<table>"+$("#biblio_"+d).html()+"</table>";""==usrconfig?$.login("LOGINFIRST",function(){""!=usrconfig&&$.open_mail([a])}):$.open_mail([a])}},{id:"exportbtn_"+d,label:" "+configlang.EXPORT,icon:"glyphicon glyphicon-export",cssClass:"btn-default hidden-xs hidden-sm",action:function(b){$(this).blur();$.open_export([a])}},{id:"checklistbtn_"+d,label:' <span class="text">'+h+"</span>",icon:f,cssClass:"btn-default checklist hidden-xs hidden-sm",
action:function(b){$(this).blur();a in favors?(delete favors[a],delete favormails[a],delete favorprint[a],$.user_message(configlang.CHECKLISTREMOVESUCCESS,"success"),b='<span class="bootstrap-dialog-button-icon fa fa-star"></span> <span class="text">'+configlang.CHECKLIST+"</span>"):(favors[a]=$("#"+a).clone().removeClass("medium col-xs-12 col-sm-6 col-md-4 col-lg-3","col-md-6").addClass("merk col-md-6"),$(favors[a]).find("a").attr("href","javascript:$.open_fullview('"+a+"',Object.keys(favors));"),
favormails[a]="<table>"+$("#biblio_"+d).html()+"</table>",favorprint[a]="<table>"+$("#biblio_"+d).html()+"</table>",$.user_message(configlang.CHECKLISTSUCCESS,"success"),b='<span class="bootstrap-dialog-button-icon fa fa-star-o"></span> <span class="text">'+configlang.CHECKLISTREMOVE+"</span>");$("#checklistbtn_"+d).html(b);$("#checklistbtn_xs_"+d).html(b);$.update_favors()}},{id:"prevbtn_xs_"+d,icon:"glyphicon glyphicon-chevron-left",cssClass:"btn-default fullview-button-left hidden-md hidden-lg col-xs-2 col-sm-1 NoLeftMargin",
action:function(e){$(this).blur();0<b.indexOf(a)?(a=b[b.indexOf(a)-1],$("#fullbody_"+d).slideUp("fast","swing",function(){$.set_fullviewppn(a,d,c,function(){$("#fullbody_"+d).slideDown("fast")})})):$.user_message(configlang.FIRSTOBJECT,"warning")}},{id:"nextbtn_xs_"+d,icon:"glyphicon glyphicon-chevron-right",cssClass:"btn-default fullview-button-left hidden-md hidden-lg col-xs-2 col-sm-1 NoLeftMargin",action:function(e){$(this).blur();"main"==c&&b.indexOf(a)<results.hits-1&&b.indexOf(a)==results.hitscurr-
1?$.search_next_pack(function(){b=results.ppnlist;a=b[b.indexOf(a)+1];$("#fullbody_"+d).slideUp("fast","swing",function(){$.set_fullviewppn(a,d,c,function(){$("#fullbody_"+d).slideDown("fast")})})}):b.indexOf(a)<b.length-1?(a=b[b.indexOf(a)+1],$("#fullbody_"+d).slideUp("fast","swing",function(){$.set_fullviewppn(a,d,c,function(){$("#fullbody_"+d).slideDown("fast")})})):$.user_message(configlang.LASTOBJECT,"warning")}},{id:"checklistbtn_xs_"+d,label:' <span class="text">'+h+"</span>",icon:f,cssClass:"btn-default checklist hidden-md hidden-lg col-xs-4 col-sm-4 LeftOffset2",
action:function(b){$(this).blur();a in favors?(delete favors[a],delete favormails[a],delete favorprint[a],$.user_message(configlang.CHECKLISTREMOVESUCCESS,"success"),b='<span class="bootstrap-dialog-button-icon fa fa-star"></span> <span class="text">'+configlang.CHECKLIST+"</span>"):(favors[a]=$("#"+a).clone().removeClass("medium col-xs-12 col-sm-6 col-md-4 col-lg-3","col-md-6").addClass("merk col-md-6"),$(favors[a]).find("a").attr("href","javascript:$.open_fullview('"+a+"',Object.keys(favors));"),
favormails[a]="<table>"+$("#biblio_"+d).html()+"</table>",favorprint[a]="<table>"+$("#biblio_"+d).html()+"</table>",$.user_message(configlang.CHECKLISTSUCCESS,"success"),b='<span class="bootstrap-dialog-button-icon fa fa-star-o"></span> <span class="text">'+configlang.CHECKLISTREMOVE+"</span>");$("#checklistbtn_"+d).html(b);$("#checklistbtn_xs_"+d).html(b);$.update_favors()}},{label:" "+configlang.CANCEL,icon:"glyphicon glyphicon-menu-up",cssClass:"btn-default hidden-md hidden-lg col-xs-4 col-sm-2 LeftOffset2",
action:function(a){a.close();$.focus_first()}},{id:"qrcodebtn_xs_"+d,label:" QR",icon:"fa fa-qrcode",cssClass:"btn-default hidden-md hidden-lg col-xs-2 col-sm-2 NoLeftMargin",action:function(a){$(this).blur();$.open_qrcode()}},{id:"exportbtn_xs_"+d,label:" "+configlang.EXPORT,icon:"glyphicon glyphicon-export",cssClass:"btn-default hidden-md hidden-lg col-xs-4 col-sm-2 LeftOffset2",action:function(b){$(this).blur();$.open_export([a])}},{id:"printbtn_xs_"+d,label:" "+configlang.PRINT,icon:"fa fa-print",
cssClass:"btn-default hidden-md hidden-lg col-xs-3 col-sm-2 NoLeftMargin",action:function(a){$(this).blur();a=window.open();a.document.write("<html><head><title>"+xtitle+"</title></head><body><p><img src='"+config.printlogo+"' style='max-width:300px;' />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span><b>"+config.softwarename+" - "+urlport+window.location.host+"</b></span></p>");a.document.write("<table>"+$("#biblio_"+d).html()+"</table>");a.document.write("</body></html");a.document.close();
a.focus();a.print();a.close()}},{id:"mailbtn_xs_"+d,label:" "+configlang.MAIL,icon:"glyphicon glyphicon-envelope",cssClass:"btn-default hidden-md hidden-lg col-xs-3 col-sm-2 LeftOffset2",action:function(b){$(this).blur();favormails[a]="<table>"+$("#biblio_"+d).html()+"</table>";""==usrconfig?$.login("LOGINFIRST",function(){""!=usrconfig&&$.open_mail([a])}):$.open_mail([a])}}],onhidden:function(){dialogs.pop();$.show_answer();statevals.ppnlist.pop();$.replace_state()},onshown:function(){dialogs.push(l);
$.set_fullviewppn(a,d,c,function(){$.is_Empty(statevals)&&(statevals={});$.is_Empty(statevals.ppnlist)&&(statevals.ppnlist=[]);statevals.ppnlist.push({ppn:a,ppnlist:b,typ:c,parentppn:e})})}});l.realize();l.getModalHeader().addClass("preview-header");l.setData("ppn",a);l.setData("name","fullview_"+d);l.open()};
$.set_fullviewppn=function(a,b,c,e){$.set_buttons(a,b,"disable");$.close_resolvers();resolver.fullview=$.ajax({url:"/ajax/fullview/"+a+"/"+b,method:"GET",crossDomain:!0,success:function(d){"publications"==c?$("#fullheader_"+b).html($("#related_"+a).html()):$("#fullheader_"+b).html($("#"+a+" div.panel-heading").html());$("#fullbody_"+b).html(d);e();$.set_buttons(a,b,"enable");$.opened_fullview(a,b)}})};
$.set_buttons=function(a,b,c){c=void 0===c?"enable":c;"disable"==c&&(config.button_checklist?($("#checklistbtn_"+b).prop("disabled",!0),$("#checklistbtn_xs_"+b).prop("disabled",!0)):($("#checklistbtn_"+b).hide(),$("#checklistbtn_xs_"+b).hide()),config.button_export?($("#exportbtn_"+b).prop("disabled",!0),$("#exportbtn_xs_"+b).prop("disabled",!0)):($("#exportbtn_"+b).hide(),$("#exportbtn_xs_"+b).hide()),config.button_qrcode?($("#qrcodebtn_"+b).prop("disabled",!0),$("#qrcodebtn_xs_"+b).prop("disabled",
...
"total";facetvals.formats={};facetvals.yearmin=facetvals.yearminbase;facetvals.yearmax=facetvals.yearmaxbase;facetvals.yearminstart=facetvals.yearminbase;facetvals.yearmaxstart=facetvals.yearmaxbase;facetvals.yearrange="["+facetvals.yearminbase+" TO "+facetvals.yearmaxbase+"]";c==JSON.stringify(settings)&&h==facetvals.yearrange&&e==facetvals.datapool&&d==facetvals.phonetic||$.new_search("init",$("#searchtext_md").val());a.close()})}}],onhidden:function(){dialogs.pop();$.show_answer();"undefined"!=
typeof slider3&&slider3.noUiSlider.destroy()},onshow:function(){config.lbs||f.getButton("loadsettings").hide();config.lbs||f.getButton("savesettings").hide()},onshown:function(){slider3=document.getElementById("pubyear3");noUiSlider.create(slider3,b);slider3.style.margin="10px 20px 10px 20px";slider3.noUiSlider.on("update",function(a,b){$(".yearstart2").html(Math.floor(a[0]));$(".yearend2").html(Math.floor(a[1]));facetvals.yearminbase=Math.floor(a[0]);facetvals.yearmaxbase=Math.floor(a[1])});"global"==
facetvals.datapool&&$("#communitylibraries").prop("checked",!0);1==facetvals.phonetic&&$("#phoneticSwitch").prop("checked",!0);$("#titleFilterValue").html(settings.title);$("#authorFilterValue").html(settings.author);$("#subjectFilterValue").html(settings.subject);$("#classFilterValue").html(settings.class);$("#tocFilterValue").html(settings.toc);$("#publisherFilterValue").html(settings.publisher);$("#isnFilterValue").html(settings.isn);$("#seriesFilterValue").html(settings.series);$("#idFilterValue").html(settings.id);
$.format_filterboxes();$.fn.editableform.template='<form class="form-inline editableform"><div class="control-group"><div><div class="editable-input"></div><div class="editable-buttons"></div></div><div class="editable-error-block"></div></div></form>';$.fn.editableform.buttons='<button type="button" onClick="javascript:$(this).closest(\'form\').find(\'textarea, .yearinput\').val(\'\');" class="btn btn-default editbutton"><i class="fa fa-times" aria-hidden="true"></i></button> <button type="submit" class="btn fullview-button-color editbutton editable-submit"><i class="fa fa-check" aria-hidden="true"></i></button>';
$(".editable").editable();$(".yearstart2").on("shown",function(a,b){b.input.$input.val($(".yearstart2").html())});$(".yearend2").on("shown",function(a,b){b.input.$input.val($(".yearend2").html())});$(".yearstart2").on("save",function(a,b){facetvals.yearminstart=Math.floor(b.newValue);slider3.noUiSlider.set([facetvals.yearminstart,facetvals.yearmaxstart])});$(".yearend2").on("save",function(a,b){facetvals.yearmaxstart=Math.floor(b.newValue);slider3.noUiSlider.set([facetvals.yearminstart,facetvals.yearmaxstart])});
dialogs.push(f)}});f.realize();f.getModalHeader().addClass("preview-header");f.setData("name","settings");f.open()};
...
xtitle+"</title></head><body><p><img src='"+urlport+window.location.host+"/"+config.printlogo+"' style='max-width:300px;' />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span><b>"+config.softwarename+" - "+urlport+window.location.host+"</b></span></p>");for(var b=Object.keys(favorprint),e=0,d=b.length;e<d;e++)a.document.write(favorprint[b[e]]),e<d-1&&a.document.write("<hr>");a.document.write("</body></html");a.document.close();a.focus();a.print();a.close()}}},{id:"mail",icon:"glyphicon glyphicon-envelope",
...
configlang.CHECKLISTCLEARSUCCESS;$.update_favors();a.close()}}],onhidden:function(){dialogs.pop();$.show_answer();$.focus_first()},onshown:function(){dialogs.push(a);$.update_favors()}});a.realize();a.getModalHeader().addClass("preview-header");config.button_export||a.getButton("export").hide();config.button_mail||a.getButton("mail").hide();config.button_print||a.getButton("print").hide();a.setData("name","favors");a.open()};
$.open_filters=function(a){var b="<div id='filterbody'><ul class='list-group'>";$.each({title:configlang.TITLE,author:configlang.PARTICIPANTS,subject:configlang.SUBJECT,class:configlang.CLASS,publisher:configlang.PUBLISHER,toc:configlang.TOC,id:configlang.ID,series:configlang.SERIES,isn:configlang.ISN},function(a,c){b+="<li class='list-group-item'>";b+=c;b+="<div class='material-switch pull-right'>";b+="<input id='"+a+"Filter' value='"+a+"' class='"+a+"Filter filter' type='checkbox'";-1<filters.indexOf(a)&&
...
"warning"),""==user?$("#kennung").focus():$("#passwort").focus(),-1;$.close_resolvers();$.post("/ajax/login",{user:user,pw:pw},function(f){"-1"!=f?(a.close(),$(".nologinarea").addClass("hide"),$(".loginarea").removeClass("hide"),usrconfig=f,timer=!0,$.startTimer(),answer.status="success",answer.message=configlang.LOGINSUCCESS.replace("{firstname}",f.firstname).replace("{lastname}",f.lastname),f.message&&(c="warning",e=f.messagetext),f.note&&(d="warning",h=f.note),b()):($.user_message(configlang.LOGINERROR,
"warning"),$("#kennung").focus(),usrconfig="");$.focus_first()},"json")}}],onhidden:function(){dialogs.pop();$.show_answer();""!=c&&$.user_message(e,c,1E4);""!=d&&$.user_message(h,d,1E4)},onshown:function(){dialogs.push(f);"1"==config.devmode&&($("#kennung").val(config.devuser),$("#passwort").val(config.devpassword));$("#kennung").focus();$(".keyenter").keypress(function(a){13==a.which&&($(this).blur(),$("#loginbutton").focus().click())});void 0!=a&&""!=a&&$.user_message(configlang[a],"warning")}});
f.realize();f.getModalHeader().addClass("preview-header");f.setData("name","login");f.open()};$.loginonly=function(){$.login("",function(){})};
$.logout=function(){var a=new BootstrapDialog({message:"<div>"+configlang.LOGOUTREALLY.replace("{system}",config.softwarename)+'<div id="logout_messagebar"></div></div>',title:"Logout "+config.softwarename,closable:!0,buttons:[{icon:"glyphicon glyphicon-menu-up",label:" "+configlang.CANCEL,action:function(a){a.close();$.focus_first()}},{icon:"glyphicon glyphicon-log-out",label:" "+configlang.LOGOUT,cssClass:"fullview-button-color",action:function(a){$.close_resolvers();$.post("/ajax/logout",function(b){a.close();
$(".nologinarea").removeClass("hide");$(".loginarea").addClass("hide");$.reset_session()},"json")}}],onhidden:function(){dialogs.pop();$.show_answer()},onshown:function(){dialogs.push(a)}});a.realize();a.getModalHeader().addClass("preview-header");a.setData("name","logout");a.open()};
$.shelve=function(a,b,c,e){c=a="";for(var d in e)"action"!=d&&"typ"!=d&&"id"!=d&&"iln"!=d&&"class"!=d&&""!=e[d]&&(""==c&&(c=d.replace(/\d/g,"")),""!=c&&c!=d.replace(/\d/g,"")&&(c=d.replace(/\d/g,""),a+="<br />"),a+=e[d].replace(/%lt%/g,"&lt;").replace(/%gt%/g,"&gt;"),"list"!=c&&(a+="<br />"));a+='<br /><div id="shelve_messagebar"></div>';e=$("#"+b+" div.panel-heading").html();void 0==e&&(e=$("#related_"+b).html());var h=new BootstrapDialog({message:a,title:e,closable:!0,buttons:[{icon:"glyphicon glyphicon-menu-up",
label:" "+configlang.CANCEL,action:function(a){a.close();$.focus_first()}}],onhidden:function(){dialogs.pop();$.show_answer()},onshown:function(){dialogs.push(h)}});h.realize();h.getModalHeader().addClass("preview-header");h.setData("name","shelve");h.open()};
$.reservation=function(a,b,c,e){if(void 0!=e.id){var d=c="";for(f in e)if("action"!=f&&"typ"!=f&&"id"!=f&&"iln"!=f&&"class"!=f&&""!=e[f])if(""==d&&(d=f.replace(/\d/g,"")),""!=d&&d!=f.replace(/\d/g,"")&&("radio"!=d&&(c+="<br />"),d=f.replace(/\d/g,"")),"radio"==d)if("radio0"==f)c+=e[f]+"<br />";else{var h=e[f].split("|");c+="<div class='radio'><label><input type='radio' value='"+h[0]+"' name='counter'>"+h[1]+"</label></div>"}else"hidden"==d?c+="<input class='hidden' type='text' value='"+e[f]+"' name='counter'>":
(c+=e[f].replace(/%lt%/g,"&lt;").replace(/%gt%/g,"&gt;"),"list"!=d&&(c+="<br />"));c+='<div id="reservation_messagebar"></div>';var f=$("#"+b+" div.panel-heading").html();void 0==f&&(f=$("#related_"+b).html());var g=new BootstrapDialog({message:c,title:f,closable:!0,buttons:[{icon:"glyphicon glyphicon-menu-up",label:" "+configlang.CANCEL,action:function(a){a.close();$.focus_first()}},{icon:"fa fa-map-marker",label:" "+configlang.RESERVATION,cssClass:"fullview-button-color",action:function(b){$(this).blur();
var c="";if($("input[name='counter']").length)if($("input[name='counter']").is(":hidden"))c=$("input[name='counter']:hidden").val();else{if(!$("input[name='counter']").is(":checked")){$.user_message(configlang.SELECTDESK,"warning");return}c=$("input[name='counter']:checked").val()}$.request(a,e.id,configlang.RESERVATIONSUCCESS,c,"reserve",function(a){"warning"==a.status?($.user_message(a.message,a.status),a.message="",a.status=""):b.close()})}}],onhidden:function(){dialogs.pop();$.show_answer()},
onshown:function(){dialogs.push(g)}});g.realize();g.getModalHeader().addClass("preview-header");g.setData("name","reservation");g.open()}};
$.order=function(a,b,c,e){if(void 0!=e.id){var d=c="";for(f in e)if("action"!=f&&"typ"!=f&&"id"!=f&&"iln"!=f&&"class"!=f&&""!=e[f])if(""==d&&(d=f.replace(/\d/g,"")),""!=d&&d!=f.replace(/\d/g,"")&&("radio"!=d&&(c+="<br />"),d=f.replace(/\d/g,"")),"radio"==d)if("radio0"==f)c+=e[f]+"<br />";else{var h=e[f].split("|");c+="<div class='radio'><label><input type='radio' value='"+h[0]+"' name='counter'>"+h[1]+"</label></div>"}else"hidden"==d?c+="<input class='hidden' type='text' value='"+e[f]+"' name='counter'>":
(c+=e[f].replace(/%lt%/g,"&lt;").replace(/%gt%/g,"&gt;"),"list"!=d&&(c+="<br />"));c+='<div id="order_messagebar"></div>';var f=$("#"+b+" div.panel-heading").html();void 0==f&&(f=$("#related_"+b).html());var g=new BootstrapDialog({message:c,title:f,closable:!0,buttons:[{icon:"glyphicon glyphicon-menu-up",label:" "+configlang.CANCEL,action:function(a){a.close();$.focus_first()}},{icon:"fa fa-map-marker",label:" "+configlang.ORDER,cssClass:"fullview-button-color",action:function(b){$(this).blur();var c=
"";if($("input[name='counter']").length)if($("input[name='counter']").is(":hidden"))c=$("input[name='counter']:hidden").val();else{if(!$("input[name='counter']").is(":checked")){$.user_message(configlang.SELECTDESK,"warning");return}c=$("input[name='counter']:checked").val()}$.request(a,e.id,configlang.ORDERSUCCESS,c,"order",function(a){"warning"==a.status?($.user_message(a.message,a.status),a.message="",a.status=""):b.close()})}}],onhidden:function(){dialogs.pop();$.show_answer()},onshown:function(){dialogs.push(g)}});
g.realize();g.getModalHeader().addClass("preview-header");g.setData("name","order");g.open()}};
$.request=function(a,b,c,e,d,h){$.close_resolvers();""==usrconfig?$.login("LOGINFIRST",function(){$.post("/ajax/request",{iln:a,uri:b,desk:e,action:d},function(a){0>a.status?(answer.status="warning",answer.message=configlang.PROCESSSTOPPED+"<br />"+a.error):(answer.status="success",answer.message=c);h(answer)},"json")}):$.post("/ajax/request",{iln:a,uri:b,desk:e,action:d},function(a){0>a.status?(answer.status="warning",answer.message=configlang.PROCESSSTOPPED+"<br />"+a.error):(answer.status="success",
answer.message=c);h(answer)},"json")};$.getfullbody=function(){var a="",b=dialogs.length;do $("#biblio_"+b).length&&(a=$("#biblio_"+b).html()),b--;while(""==a&&0<=b);return a};
$.mailorder=function(a,b,c,e){a=$("#"+b+" div.panel-heading").html();void 0==a&&(a=$("#related_"+b).html());var d="ORDER",h="MAILORDER",f="Magazinbestellung";$.close_resolvers();var g=new BootstrapDialog({message:$('<div id="mailorderviewbody"></div>').load("/ajax/mailorderview/"+b+"/"+c,function(a,b,c){d=$(a).wrapAll($("<div>")).parent().find("#mailbutton").attr("value").toString();h=$(a).wrapAll($("<div>")).parent().find("#mailtyp").attr("value").toString();f=$(a).wrapAll($("<div>")).parent().find("#mailsubject").attr("value").toString();
g.getButton("mailbtn").html("<span class='bootstrap-dialog-button-icon fa fa-map-marker'></span> "+d)}),title:a,closable:!0,buttons:[{icon:"glyphicon glyphicon-menu-up",label:" "+configlang.CANCEL,action:function(a){a.close();$.focus_first()}},{id:"mailbtn",icon:"fa fa-map-marker",label:" "+configlang.ORDER,cssClass:"fullview-button-color",action:function(a){$(this).blur();var c=$("input[name=mailto]:checked").val(),d=$("input[name=mailto]:checked").parent().text();void 0==c&&(c=$("#mailto").attr("value"));
void 0==d&&(d=$("#mailto").data("label"));if(void 0==c)return $.user_message("Die MailTo-Adresse konnte nicht ermittelt werden!","warning"),-1;var g=$("input[name=mailfrom]:checked").val();void 0==g&&(g=$("#mailfrom").attr("value"));if(void 0==g)return $.user_message("Die MailFrom-Adresse konnte nicht ermittelt werden!","warning"),-1;if(""==usrconfig)$.login("LOGINFIRST",function(){var l={},k=$("input[name=volume]").val();void 0!=k&&(l.volume=k);k=$("#msg").val();void 0==k&&(k=$("input[name=msg]:checked").val());
void 0!=k&&(l.msg=k);k="<table>"+$.getfullbody()+"</table>";$.post("/ajax/mailorderto",{exemplar:JSON.stringify(e),fullbody:JSON.stringify(k),ppn:b,mailto:c,mailtoname:d,mailfrom:g,userinput:JSON.stringify(l),mailtyp:h,mailsubject:f,userconfig:JSON.stringify(usrconfig)},function(b){if(0>b.status){if(-3==b.status)return $.user_message(b.error,"warning"),!1;$.user_message(configlang.PROCESSSTOPPED+"<br />"+b.error,"warning")}else answer.status="success",answer.message=configlang.ORDERSUCCESS,a.close()},
"json")});else{var l={},k=$("input[name=volume]").val();void 0!=k&&(l.volume=k);k=$("#msg").val();void 0==k&&(k=$("input[name=msg]:checked").val());void 0!=k&&(l.msg=k);k="<table>"+$.getfullbody()+"</table>";$.post("/ajax/mailorderto",{exemplar:JSON.stringify(e),fullbody:JSON.stringify(k),ppn:b,mailto:c,mailtoname:d,mailfrom:g,userinput:JSON.stringify(l),mailtyp:h,mailsubject:f,userconfig:JSON.stringify(usrconfig)},function(b){if(0>b.status){if(-3==b.status)return $.user_message(b.error,"warning"),
!1;$.user_message(configlang.PROCESSSTOPPED+"<br />"+b.error,"warning")}else answer.status="success",answer.message=configlang.ORDERSUCCESS,a.close()},"json")}}}],onhidden:function(){dialogs.pop();$.show_answer()},onshown:function(a){dialogs.push(g)}});g.realize();g.getModalHeader().addClass("preview-header");g.setData("name","mailorder");g.open()};
$.cancel=function(a,b,c){$.close_resolvers();$.post("/ajax/cancel",{iln:a,uri:b},function(a){if(0>a.status){if(-3==a.status)return $.user_message(a.error,"warning"),!1;$.user_message(configlang.PROCESSSTOPPED+"<br />"+a.error,"warning")}else $("#reservation_"+c).hide(),$.user_message(configlang.CANCELSUCCESS,"success")},"json")};
$.renew=function(){$.close_resolvers();$(".status_renew").html("");$(".check_renew").each(function(a){if(1==$(this).prop("checked")){$(this).prop("checked",!1);a=$(this).data("item");var b=a.substring(Math.max(a.lastIndexOf(":"),a.lastIndexOf("$"))+1),c=$(this).data("iln");$.post("/ajax/renew",{iln:c,uri:a},function(a){if(-3==a.status)return $.user_message(a.error,"warning"),!1;-2==a.status?($("#status_renew_"+b).html('<font color="red"><a href="#" data-toggle="tooltip" title="'+a.error+'"><i class="fa fa-exclamation" aria-hidden="true"></i></font>'),
$("#checkbox_renew_"+b).html("")):($("#status_renew_"+b).html('<font color="green"><i class="fa fa-check" aria-hidden="true"></i></font>'),"endtime"in a&&$("#return_renew_"+b).html(a.endtime),"renewals"in a&&(0<maxrenewals?($("#renewals_renew_"+b).html(a.renewals+" / "+maxrenewals),parseInt(a.renewals)>=maxrenewals&&$("#checkbox_renew_"+b).html("")):$("#renewals_renew_"+b).html(a.renewals)),"reminder"in a&&$("#reminder_renew_"+b).html(a.reminder))},"json")}});$(".btn-renew").blur()};
