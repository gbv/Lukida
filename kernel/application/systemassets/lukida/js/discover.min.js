...
$jscomp.polyfill("Array.prototype.find",function(a){return a?a:function(a,c){return $jscomp.findInternal(this,a,c).v}},"es6","es3");$jscomp.arrayIteratorImpl=function(a){var b=0;return function(){return b<a.length?{done:!1,value:a[b++]}:{done:!0}}};$jscomp.arrayIterator=function(a){return{next:$jscomp.arrayIteratorImpl(a)}};$jscomp.SYMBOL_PREFIX="jscomp_symbol_";$jscomp.initSymbol=function(){$jscomp.initSymbol=function(){};$jscomp.global.Symbol||($jscomp.global.Symbol=$jscomp.Symbol)};
...
yearmaxbase:"",typ:"total",formats:{},sort:"scoredesc"},statevals={ppnlist:[],language:"",layout:""},favors={},favormails={},favorprint={},idleTimer,time2warn=1080,time2kill=120,timer=!1,maxrenewals=0,urlport=location.protocol+"//",linkresolver=!1,linkresolverclass="col-xs-12 col-sm-6 col-md-4",delay=function(){var a=0;return function(b,c){clearTimeout(a);a=setTimeout(b,c)}}(),marcCheck=!0,formate={Article:1,Book:2,Journal:4,Microform:8,Sound_Recording:16,Serial_Volume:32,Musical_Score:64,Mixed_Materials:128,
Data_Media:256,Motion_Picture:512,electronic_Resource:1024,Map:2048,unknown:4096,Game:8192,Manuscript:16384},formats={Article:!1,Book:!1,Journal:!1,Microform:!1,"Sound Recording":!1,"Serial Volume":!1,"Musical Score":!1,"Mixed Materials":!1,"Data Media":!1,"Motion Picture":!1,"electronic Resource":!1,Map:!1,unknown:!1,Game:!1,Manuscript:!1},formatslanguagesort=[],view={},filters=[],settings={title:"",author:"",subject:"",class:"",publisher:"",toc:"",id:"",series:"",isn:""},settingsname,isMobile=window.matchMedia("only screen and (max-width: 760px)").matches,
intervalID="",$JSONData,answer={status:"",message:""},resolver={fullview:null,google:null,link:null,simular:null,export:null};$.is_Empty=function(a){if(null==a)return!0;if(0<a.length)return!1;if(0===a.length||"object"!==typeof a)return!0;for(var b in a)if(hasOwnProperty.call(a,b))return!1;return!0};$.focus_first=function(){isMobile||$('[type="search"]:input:enabled:visible:first').focus()};$.remove_tooltips=function(){$(".countSettings").tooltip("hide");$(".countFavors").tooltip("hide")};
$.close_wait=function(){waitdialog.close()};$.validateEmail=function(a){return/^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/.test(a)};$.cleanArray=function(a){for(var b=0;b<a.length;b++)void 0==a[b].trim()||""==a[b].trim()?(a.splice(b,1),b--):a[b]=a[b].trim();return a};$.SetQuery=function(){querystate?0<results.hits?($("#querybar_querybar").hide(),$("#results_querybar").show()):($("#querybar_querybar").show(),$("#results_querybar").hide()):($("#querybar_querybar").hide(),$("#results_querybar").hide())};
...
$.user_message=function(a,b,c){void 0==c&&(c=5E3);if(0<dialogs.length){var e=dialogs[dialogs.length-1].getData("name");"mail"==e&&(e="fullview_"+(dialogs.length-2).toString())}else e=0<results.hits?"results":"statusbar";var d="success"==b?"panel-success":"panel-danger";messid++;$("#"+e+"_messagebar").append($("<div id='message"+messid+"' class='alert-message "+b+"' data-alert></div>"));$("#message"+messid).hide().html("<div class='panel "+d+"'><div class='panel-heading'>"+a+"</div></div>").fadeIn("fast");
...
"local"==facetvals.datapool.toLowerCase()?($(".datapoollocal").removeClass("hide"),$(".datapoolglobal").addClass("hide")):($(".datapoollocal").addClass("hide"),$(".datapoolglobal").removeClass("hide"));""!=searchvals.inittext&&(0==a&&(a=""),$(".countSettings").html(a.toString()),""!=a&&($(".countSettings").tooltip("show"),setTimeout($.remove_tooltips,2E3),intervalID=setInterval(function(){$(".countSettings").animate({opacity:"0.5"}).delay(1E3).animate({opacity:"1"})},3E3)),$.when($.new_search("initfacets",
searchvals.inittext)).done(function(){searchvals.inittext=""}));$(".search_clear").toggle(!!$(".search_text").val())},"JSON")};$.url_clean=function(a){return encodeURIComponent(a.replace(/"/g,"%22").replace(/\//g,"{slash}").replace(/</g,"{st}").replace(/>/g,"{gt}").replace(/:/g,"{colon}").replace(/\*/g,"{star}"))};
...
$.clear_search=function(){$.close_dialogs();$("#searchtext_xs").val("");$("#searchtext_md").val("");$("#facets").fadeOut("fast").addClass("collapse");$("#results").addClass("collapse");$("#resultsonly").html("");$("#loading").fadeOut("fast").addClass("collapse");$("#start").fadeIn("fast").removeClass("collapse");results={hits:0,hitspack:0,hitscurr:0,qtime:"",ppnlist:{},spell:{},status:0};searchvals={text:"",last:"",package:1,inittext:"",initfacets:{}};facetvals.yearrange="";facetvals.yearmin="";facetvals.yearmax=
"";facetvals.yearminstart="";facetvals.yearmaxstart="";facetvals.typ="total";facetvals.formats={};facetvals.sort="scoredesc";$.replace_state();$.focus_first()};
...
a.focus();a.print();a.close()}},{id:"mailbtn_xs_"+d,label:" "+configlang.MAIL,icon:"glyphicon glyphicon-envelope",cssClass:"btn-default hidden-md hidden-lg col-xs-3 col-sm-2 LeftOffset2",action:function(b){$(this).blur();favormails[a]="<table>"+$("#biblio_"+d).html()+"</table>";""==usrconfig?$.login("LOGINFIRST",function(){""!=usrconfig&&$.open_mail([a])}):$.open_mail([a])}}],onhidden:function(){dialogs.pop();$.show_answer();statevals.ppnlist.pop();$.replace_state()},onshown:function(){dialogs.push(k);
$.set_fullviewppn(a,d,c,function(){$.is_Empty(statevals)&&(statevals={});$.is_Empty(statevals.ppnlist)&&(statevals.ppnlist=[]);statevals.ppnlist.push({ppn:a,ppnlist:b,typ:c,parentppn:e})})}});k.realize();k.getModalHeader().addClass("preview-header");k.setData("ppn",a);k.setData("name","fullview_"+d);k.open()};
...
e.close())})}}],onhidden:function(){dialogs.pop();$.show_answer()},onshown:function(){dialogs.push(e);$("#username").focus()}});e.realize();e.getModalHeader().addClass("preview-header");e.setData("name","mail");e.open()}};
...
"warning"),""==user?$("#kennung").focus():$("#passwort").focus(),-1;$.post("/ajax/login",{user:user,pw:pw},function(d){"-1"!=d?(a.close(),$(".nologinarea").addClass("hide"),$(".loginarea").removeClass("hide"),usrconfig=d,timer=!0,$.startTimer(),answer.status="success",answer.message=configlang.LOGINSUCCESS.replace("{firstname}",d.firstname).replace("{lastname}",d.lastname),d.message&&(c="warning",e=d.messagetext),b()):($.user_message(configlang.LOGINERROR,"warning"),$("#kennung").focus(),usrconfig=
"");$.focus_first()},"json")}}],onhidden:function(){dialogs.pop();$.show_answer();""!=c&&$.user_message(e,c,1E4)},onshown:function(){dialogs.push(d);"1"==config.devmode&&($("#kennung").val(config.devuser),$("#passwort").val(config.devpassword));$("#kennung").focus();$(".keyenter").keypress(function(a){13==a.which&&($(this).blur(),$("#loginbutton").focus().click())});void 0!=a&&""!=a&&$.user_message(configlang[a],"warning")}});d.realize();d.getModalHeader().addClass("preview-header");d.setData("name",
"login");d.open()};$.loginonly=function(){$.login("",function(){})};
...
$.shelve=function(a,b,c,e){c=a="";for(var d in e)"action"!=d&&"typ"!=d&&"id"!=d&&""!=e[d]&&(""==c&&(c=d.replace(/\d/g,"")),""!=c&&c!=d.replace(/\d/g,"")&&(c=d.replace(/\d/g,""),a+="<br />"),a+=e[d].replace(/%lt%/g,"&lt;").replace(/%gt%/g,"&gt;")+"<br />");a+='<br /><div id="shelve_messagebar"></div>';e=$("#"+b+" div.panel-heading").html();void 0==e&&(e=$("#related_"+b).html());var h=new BootstrapDialog({message:a,title:e,closable:!0,buttons:[{icon:"glyphicon glyphicon-menu-up",label:" "+configlang.CANCEL,
action:function(a){a.close();$.focus_first()}}],onhidden:function(){dialogs.pop();$.show_answer()},onshown:function(){dialogs.push(h)}});h.realize();h.getModalHeader().addClass("preview-header");h.setData("name","shelve");h.open()};
$.reservation=function(a,b,c,e){if(void 0!=e.id){var d=c="";for(f in e)if("action"!=f&&"typ"!=f&&"id"!=f&&"iln"!=f&&""!=e[f])if(""==d&&(d=f.replace(/\d/g,"")),""!=d&&d!=f.replace(/\d/g,"")&&("radio"!=d&&(c+="<br />"),d=f.replace(/\d/g,"")),"radio"==d)if("radio0"==f)c+=e[f]+"<br />";else{var h=e[f].split("|");c+="<div class='radio'><label><input type='radio' value='"+h[0]+"' name='counter'>"+h[1]+"</label></div>"}else c="hidden"==d?c+("<input class='hidden' type='text' value='"+e[f]+"' name='counter'>"):
c+(e[f].replace(/%lt%/g,"&lt;").replace(/%gt%/g,"&gt;")+"<br />");c+='<div id="reservation_messagebar"></div>';var f=$("#"+b+" div.panel-heading").html();void 0==f&&(f=$("#related_"+b).html());var g=new BootstrapDialog({message:c,title:f,closable:!0,buttons:[{icon:"glyphicon glyphicon-menu-up",label:" "+configlang.CANCEL,action:function(a){a.close();$.focus_first()}},{icon:"fa fa-map-marker",label:" "+configlang.RESERVATION,cssClass:"fullview-button-color",action:function(b){$(this).blur();var c=
"";if($("input[name='counter']").length)if($("input[name='counter']").is(":hidden"))c=$("input[name='counter']:hidden").val();else{if(!$("input[name='counter']").is(":checked")){$.user_message(configlang.SELECTDESK,"warning");return}c=$("input[name='counter']:checked").val()}$.request(a,e.id,configlang.RESERVATIONSUCCESS,c,"reserve",function(a){"warning"==a.status?($.user_message(a.message,a.status),a.message="",a.status=""):b.close()})}}],onhidden:function(){dialogs.pop();$.show_answer()},onshown:function(){dialogs.push(g)}});
g.realize();g.getModalHeader().addClass("preview-header");g.setData("name","reservation");g.open()}};
$.order=function(a,b,c,e){if(void 0!=e.id){var d=c="";for(f in e)if("action"!=f&&"typ"!=f&&"id"!=f&&"iln"!=f&&""!=e[f])if(""==d&&(d=f.replace(/\d/g,"")),""!=d&&d!=f.replace(/\d/g,"")&&("radio"!=d&&(c+="<br />"),d=f.replace(/\d/g,"")),"radio"==d)if("radio0"==f)c+=e[f]+"<br />";else{var h=e[f].split("|");c+="<div class='radio'><label><input type='radio' value='"+h[0]+"' name='counter'>"+h[1]+"</label></div>"}else c="hidden"==d?c+("<input class='hidden' type='text' value='"+e[f]+"' name='counter'>"):
c+(e[f].replace(/%lt%/g,"&lt;").replace(/%gt%/g,"&gt;")+"<br />");c+='<div id="order_messagebar"></div>';var f=$("#"+b+" div.panel-heading").html();void 0==f&&(f=$("#related_"+b).html());var g=new BootstrapDialog({message:c,title:f,closable:!0,buttons:[{icon:"glyphicon glyphicon-menu-up",label:" "+configlang.CANCEL,action:function(a){a.close();$.focus_first()}},{icon:"fa fa-map-marker",label:" "+configlang.ORDER,cssClass:"fullview-button-color",action:function(b){$(this).blur();var c="";if($("input[name='counter']").length)if($("input[name='counter']").is(":hidden"))c=
$("input[name='counter']:hidden").val();else{if(!$("input[name='counter']").is(":checked")){$.user_message(configlang.SELECTDESK,"warning");return}c=$("input[name='counter']:checked").val()}$.request(a,e.id,configlang.ORDERSUCCESS,c,"order",function(a){"warning"==a.status?($.user_message(a.message,a.status),a.message="",a.status=""):b.close()})}}],onhidden:function(){dialogs.pop();$.show_answer()},onshown:function(){dialogs.push(g)}});g.realize();g.getModalHeader().addClass("preview-header");g.setData("name",
"order");g.open()}};
$.request=function(a,b,c,e,d,h){""==usrconfig?$.login("LOGINFIRST",function(){$.post("/ajax/request",{iln:a,uri:b,desk:e,action:d},function(a){0>a.status?(answer.status="warning",answer.message=configlang.PROCESSSTOPPED+"<br />"+a.error):(answer.status="success",answer.message=c);h(answer)},"json")}):$.post("/ajax/request",{iln:a,uri:b,desk:e,action:d},function(a){0>a.status?(answer.status="warning",answer.message=configlang.PROCESSSTOPPED+"<br />"+a.error):(answer.status="success",answer.message=
c);h(answer)},"json")};
$.mailorder=function(a,b,c,e){a=$("#"+b+" div.panel-heading").html();void 0==a&&(a=$("#related_"+b).html());var d="ORDER",h="MAILORDER",f="Magazinbestellung",g=new BootstrapDialog({message:$('<div id="mailorderviewbody"></div>').load("/ajax/mailorderview/"+b+"/"+c,function(a,b,c){d=$(a).wrapAll($("<div>")).parent().find("#mailbutton").attr("value").toString();h=$(a).wrapAll($("<div>")).parent().find("#mailtyp").attr("value").toString();f=$(a).wrapAll($("<div>")).parent().find("#mailsubject").attr("value").toString();g.getButton("mailbtn").html("<span class='bootstrap-dialog-button-icon fa fa-map-marker'></span> "+
d)}),title:a,closable:!0,buttons:[{icon:"glyphicon glyphicon-menu-up",label:" "+configlang.CANCEL,action:function(a){a.close();$.focus_first()}},{id:"mailbtn",icon:"fa fa-map-marker",label:" "+configlang.ORDER,cssClass:"fullview-button-color",action:function(a){$(this).blur();var c=$("input[name=mailto]:checked").val(),d=$("input[name=mailto]:checked").parent().text();void 0==c&&(c=$("#mailto").attr("value"));void 0==d&&(d=$("#mailto").data("label"));if(void 0==c)return $.user_message("Die MailTo-Adresse konnte nicht ermittelt werden!",
"warning"),-1;var g=$("input[name=mailfrom]:checked").val();void 0==g&&(g=$("#mailfrom").attr("value"));if(void 0==g)return $.user_message("Die MailFrom-Adresse konnte nicht ermittelt werden!","warning"),-1;if(""==usrconfig)$.login("LOGINFIRST",function(){var k={},l=$("input[name=volume]").val();void 0!=l&&(k.volume=l);l="<table>"+$("#biblio_"+(dialogs.length-2)).html()+"</table>";$.post("/ajax/mailorderto",{exemplar:JSON.stringify(e),fullbody:JSON.stringify(l),ppn:b,mailto:c,mailtoname:d,mailfrom:g,
userinput:JSON.stringify(k),mailtyp:h,mailsubject:f},function(b){if(0>b.status){if(-3==b.status)return $.user_message(b.error,"warning"),!1;$.user_message(configlang.PROCESSSTOPPED+"<br />"+b.error,"warning")}else answer.status="success",answer.message=configlang.ORDERSUCCESS,a.close()},"json")});else{var k={},l=$("input[name=volume]").val();void 0!=l&&(k.volume=l);l="<table>"+$("#biblio_"+(dialogs.length-2)).html()+"</table>";$.post("/ajax/mailorderto",{exemplar:JSON.stringify(e),fullbody:JSON.stringify(l),
ppn:b,mailto:c,mailtoname:d,mailfrom:g,userinput:JSON.stringify(k),mailtyp:h,mailsubject:f},function(b){if(0>b.status){if(-3==b.status)return $.user_message(b.error,"warning"),!1;$.user_message(configlang.PROCESSSTOPPED+"<br />"+b.error,"warning")}else answer.status="success",answer.message=configlang.ORDERSUCCESS,a.close()},"json")}}}],onhidden:function(){dialogs.pop();$.show_answer()},onshown:function(a){dialogs.push(g)}});g.realize();g.getModalHeader().addClass("preview-header");g.setData("name",
"mailorder");g.open()};$.cancel=function(a,b,c){$.post("/ajax/cancel",{iln:a,uri:b},function(a){if(0>a.status){if(-3==a.status)return $.user_message(a.error,"warning"),!1;$.user_message(configlang.PROCESSSTOPPED+"<br />"+a.error,"warning")}else $("#reservation_"+c).hide(),$.user_message(configlang.CANCELSUCCESS,"success")},"json")};
