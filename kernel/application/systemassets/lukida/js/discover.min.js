...
function(a,b){$(".Z3988").attr("title",b)})})});$.sortRelatedMedia=function(a,b,e){var f=$(a);a=$($(a).find(b),f);a.sort(function(a,b){var c=$(a).find(e).text().toLowerCase(),d=$(b).find(e).text().toLowerCase();return c>d?1:-1});$.each(a,function(a,b){f.append(b)})}};
$.searchrelatedarticles=function(a,b,c){$.when($.ajax({url:"/ajax/searchrelatedpubs/",method:"POST",data:{ppnlink:a,search:b},dataType:"JSON"})).then(function(a){0<a.hitspack?$("#relatedarticlescontent_"+c).html(a.results):$("#relatedarticlescontent_"+c).html("<div class='col-xs-12'><div class='well'>"+configlang.NOSIMULARHITS+"</div></div>")})};$.correctCover=function(a,b){a.onerror="";$(a).replaceWith("<span class='gbvicon'>"+b+"</span>")};
