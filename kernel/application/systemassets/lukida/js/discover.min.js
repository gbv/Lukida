...
a+"/"+e,function(){config.button_checklist&&h.getButton("checklist").prop("disabled",!1);config.button_export&&h.getButton("export").prop("disabled",!1);config.button_mail&&h.getButton("mail").prop("disabled",!1);config.button_print&&h.getButton("print").prop("disabled",!1);void 0!=$("#searchrelatedpubs")&&$("#searchrelatedpubs").keyup(function(){delay(function(){var b=$("#searchrelatedpubs").val().trim();$.searchrelatedmedia(a,b,e?"#relatedpubscontent_"+e:"#relatedpubscontent_0")},1E3)});void 0!=
$("#searchrelatedjournals")&&$("#searchrelatedjournals").keyup(function(){delay(function(){var b=$("#searchrelatedjournals").val().trim();$.searchrelatedmedia(a,b,e?"#relatedjournalscontent_"+e:"#relatedjournalscontent_0")},1E3)});void 0!=$("#searchrelatedarticles")&&$("#searchrelatedarticles").keyup(function(){delay(function(){var b=$("#searchrelatedarticles").val().trim();$.searchrelatedmedia(a,b,e?"#relatedarticlescontent_"+e:"#relatedarticlescontent_0")},1E3)});$.opened_fullview(a,e)}),title:k,
size:BootstrapDialog.SIZE_WIDE,closable:!0,buttons:[{id:"prevbtn",icon:"glyphicon glyphicon-chevron-left",cssClass:"btn-default fullview-button-left",action:function(d){$(this).blur();0<b.indexOf(a)?(a=b[b.indexOf(a)-1],$("#fullbody_"+e).slideUp("fast","swing",function(){$("#fullbody_"+e).load("/ajax/fullview/"+a+"/"+e,function(){"publications"==c?d.getModalHeader().find(".bootstrap-dialog-title").html($("#related_"+a).html()):d.getModalHeader().find(".bootstrap-dialog-title").html($("#"+a+" div.panel-heading").html());
...
$.opened_fullview(a,e)})})):$.user_message(configlang.LASTOBJECT,"warning")}},{icon:"glyphicon glyphicon-menu-up",label:" "+configlang.CANCEL,action:function(a){a.close();$.focus_first()}},{id:"print",icon:"fa fa-print",label:" "+configlang.PRINT,action:function(a){$(this).blur();a=window.open();a.document.write("<html><head><title>"+configlang.PRINT+"</title></head><body>");a.document.write($("#mail_"+e).wrap("<p/>").parent().html());a.document.write("</body></html");a.document.close();a.focus();
a.print();a.close()}},{id:"mail",icon:"glyphicon glyphicon-envelope",label:" "+configlang.MAIL,action:function(b){$(this).blur();favormails[a]=$("#mail_"+e).wrap("<p/>").parent().html();""==usrconfig?$.login("LOGINFIRST",function(){""!=usrconfig&&$.open_mail([a])}):$.open_mail([a])}},{id:"export",icon:"glyphicon glyphicon-export",label:" "+configlang.EXPORT,action:function(b){$(this).blur();$.open_export([a])}},{id:"checklist",icon:g,cssClass:"btn-default checklist",label:' <span class="text">'+f+
"</span>",action:function(b){$(this).blur();b=$(this);a in favors?(delete favors[a],delete favormails[a],delete favorprint[a],$.user_message(configlang.CHECKLISTREMOVESUCCESS,"success"),b.find(".text").text(configlang.CHECKLIST),b.find(".fa").removeClass("fa-star-o"),b.find(".fa").addClass("fa-star")):(favors[a]=$("#"+a).clone().removeClass("medium col-xs-12 col-sm-6 col-md-4 col-lg-3","col-md-6").addClass("merk col-md-6"),$(favors[a]).find("a").attr("href","javascript:$.open_fullview('"+a+"',Object.keys(favors));"),
favormails[a]=$("#mail_"+e).wrap("<p/>").parent().html(),favorprint[a]=$("#mail_"+e).wrap("<p/>").parent().html(),$.user_message(configlang.CHECKLISTSUCCESS,"success"),b.find(".text").text(configlang.CHECKLISTREMOVE),b.find(".fa").removeClass("fa-star"),b.find(".fa").addClass("fa-star-o"));$.update_favors()}}],onhidden:function(){dialogs.pop();statevals.ppnlist.pop();$.push_state()},onshown:function(){dialogs.push(h);$.is_Empty(statevals)&&(statevals={});$.is_Empty(statevals.ppnlist)&&(statevals.ppnlist=
[]);statevals.ppnlist.push({ppn:a,ppnlist:b,typ:c,parentppn:d})}});h.realize();h.getModalHeader().addClass("preview-header");config.button_checklist?h.getButton("checklist").prop("disabled",!0):h.getButton("checklist").hide();config.button_export?h.getButton("export").prop("disabled",!0):h.getButton("export").hide();config.button_mail?h.getButton("mail").prop("disabled",!0):h.getButton("mail").hide();config.button_print?h.getButton("print").prop("disabled",!0):h.getButton("print").hide();h.setData("ppn",
...
window.scrollTo(0,0);$(".typeahead").typeahead({source:function(a,b){if(void 0==a)return b({});$.get("/ajax/getwords",{query:a},function(a){return b(a)},"json")},autoSelect:!1,delay:300,afterSelect:function(a){$.new_search("init",a)}});window.onpopstate=function(a){$.close_dialogs();$("#facets").fadeOut("fast").addClass("collapse");$("#results").addClass("collapse");$("#resultsonly").html("");$("#loading").fadeOut("fast").addClass("collapse");null!=a.state&&0<Object.keys(a.state).length?($.init_client(a.state.sets),
appstate.first=!0,$.new_search("initfacets",a.state.text),document.title=a.state.text+" | "+xtitle):($("#start").fadeIn("fast").removeClass("collapse"),$("#searchtext_xs").val(""),$("#searchtext_md").val(""))};$(".yearstart.inlineedit").inlineEdit($('<input name="temp_start" type="number" min="1000" max="9999" />'),$("#hiddenyearstart"));$(".yearend.inlineedit").inlineEdit($('<input name="temp_end" type="number" min="1000" max="9999" />'),$("#hiddenyearend"));$("#hiddenyearstart").change(function(){facetvals.yearminstart=
$("#hiddenyearstart").val();facetvals.yearrange="["+facetvals.yearminstart+" TO "+facetvals.yearmaxstart+"]";$.set_facet("year");slider.noUiSlider.set([facetvals.yearminstart,facetvals.yearmaxstart]);void 0!=slider2&&slider2.noUiSlider.set([facetvals.yearminstart,facetvals.yearmaxstart])});$("#hiddenyearend").change(function(){facetvals.yearmaxstart=$("#hiddenyearend").val();facetvals.yearrange="["+facetvals.yearminstart+" TO "+facetvals.yearmaxstart+"]";$.set_facet("year");slider.noUiSlider.set([facetvals.yearminstart,
facetvals.yearmaxstart]);void 0!=slider2&&slider2.noUiSlider.set([facetvals.yearminstart,facetvals.yearmaxstart])});$.focus_first()});
